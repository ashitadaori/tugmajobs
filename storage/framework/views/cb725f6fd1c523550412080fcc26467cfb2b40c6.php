        ...
        <div class="modal-content kyc-modal-enhanced">
            ...
            <div class="modal-body">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(Auth::user()->kyc_status !== 'pending'): ?>
                        <div class="alert 
                            <?php if(Auth::user()->kyc_status === 'verified'): ?> alert-success
                            <?php elseif(Auth::user()->kyc_status === 'failed'): ?> alert-danger
                            <?php elseif(Auth::user()->kyc_status === 'expired'): ?> alert-warning
                            <?php else: ?> alert-info
                            <?php endif; ?> mb-4">
                            <h6>
                                <?php if(Auth::user()->kyc_status === 'verified'): ?>
                                    <i class="fas fa-check-circle me-2"></i>
                                <?php elseif(Auth::user()->kyc_status === 'failed'): ?>
                                    <i class="fas fa-times-circle me-2"></i>
                                <?php elseif(Auth::user()->kyc_status === 'expired'): ?>
                                    <i class="fas fa-clock me-2"></i>
                                <?php else: ?>
                                    <i class="fas fa-info-circle me-2"></i>
                                <?php endif; ?>
                                Current Status: <?php echo e(ucfirst(str_replace('_', ' ', Auth::user()->kyc_status))); ?>

                            </h6>
                            <p class="mb-0 small">
                                <?php if(Auth::user()->kyc_status === 'in_progress'): ?>
            ...
            <div class="modal-footer">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php elseif(in_array(Auth::user()->kyc_status, ['in_progress', 'failed', 'expired'])): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/components/kyc-modal.blade.php ENDPATH**/ ?>