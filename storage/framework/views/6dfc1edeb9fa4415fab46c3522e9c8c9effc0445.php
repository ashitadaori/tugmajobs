        ...
        <div class="password-card-body">
            <form id="changePasswordForm" class="password-form" method="POST">
                ...
                <div class="password-actions">
                    <a href="<?php echo e(route('account.settings')); ?>" class="btn-back">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("account.changePassword")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
<?php echo $__env->make('layouts.jobseeker', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/front/account/change-password.blade.php ENDPATH**/ ?>