...
<div class="container-fluid">
    ...
    <div class="admin-dashboard-navbar mb-4">
        <div class="d-flex justify-content-between align-items-center py-3">
            ...
            <div class="admin-actions d-flex align-items-center gap-3">
                ...
                <div class="btn-group">
                    ...
                    <a href="<?php echo e(route('admin.users.index', ['kyc_status' => 'all'])); ?>" class="btn btn-outline-info btn-sm">
                        <i class="bi bi-shield-check me-1"></i> KYC Overview
                        <?php if(isset($pendingKyc) && $pendingKyc > 0): ?>
                            <span class="badge bg-warning ms-1"><?php echo e($pendingKyc); ?> pending</span>
                        <?php endif; ?>
                    </a>
                </div>
            </div>
        ...
        <div class="admin-tabs">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('admin.users.index')); ?>">
                        ...
                        <?php if(isset($totalUsers) && $totalUsers > 0): ?>
                            <span class="badge bg-primary ms-1"><?php echo e(number_format($totalUsers)); ?></span>
                        <?php endif; ?>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('admin.jobs.index')); ?>">
                        ...
                        <?php if(isset($activeJobs) && $activeJobs > 0): ?>
                            <span class="badge bg-success ms-1"><?php echo e(number_format($activeJobs)); ?></span>
                        <?php endif; ?>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('admin.analytics.dashboard')); ?>">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo e(route('admin.settings.index')); ?>">
                            <i class="bi bi-sliders me-2"></i> Settings
                        </a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('admin.settings.security-log')); ?>">
                            <i class="bi bi-shield-lock me-2"></i> Security Log
                        </a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('admin.settings.audit-log')); ?>">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group">
            <a href="<?php echo e(route('admin.dashboard.export')); ?>" class="btn btn-success" title="Export dashboard statistics to CSV">
    ...
    <div class="row g-4 mb-4">
                ...
                <div id="total-users" class="stats-card stats-card-clickable">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-0 text-dark"><?php echo e(number_format($totalUsers)); ?></h2>
                            <div class="small text-success">
                                <i class="bi bi-arrow-up"></i> <?php echo e($userGrowth); ?>% from last month
                            </div>
                        </div>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <a href="<?php echo e(route('admin.companies.index')); ?>" class="text-decoration-none">
                <div id="active-jobs" class="stats-card stats-card-clickable">
                    <div class="live-indicator"></div>
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h6 class="text-muted mb-2">Active Jobs</h6>
                            <h2 class="mb-0 text-dark"><?php echo e(number_format($activeJobs)); ?></h2>
                            <div class="small text-success">
                                <i class="bi bi-arrow-up"></i> <?php echo e($jobGrowth); ?>% from last month
                            </div>
                        </div>
                        <div class="flex-shrink-0 ms-3">
                            <div class="bg-light rounded-circle p-3">
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <a href="<?php echo e(route('admin.jobs.pending')); ?>" class="text-decoration-none">
                <div id="pending-jobs" class="stats-card stats-card-clickable <?php echo e($pendingJobs > 0 ? 'border-warning' : ''); ?>">
                    <?php if($pendingJobs > 0): ?>
                        <div class="position-absolute top-0 end-0 p-2">
                            <span class="badge bg-warning text-dark pulse-animation"><?php echo e($pendingJobs); ?></span>
                        </div>
                    <?php endif; ?>
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h6 class="text-muted mb-2">Pending Jobs</h6>
                            <h2 class="mb-0 <?php echo e($pendingJobs > 0 ? 'text-warning' : 'text-dark'); ?>"><?php echo e(number_format($pendingJobs)); ?></h2>
                            <div class="small">
                                <?php if($pendingJobs > 0): ?>
                        ...
                        <div class="flex-shrink-0 ms-3">
                            <div class="bg-light rounded-circle p-3">
                                <i class="bi bi-clock-history <?php echo e($pendingJobs > 0 ? 'text-warning' : 'text-muted'); ?>"></i>
                            </div>
                        </div>
                    </div>
                    <div class="card-hover-indicator">
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <a href="<?php echo e(route('admin.kyc.didit-verifications')); ?>" class="text-decoration-none">
                <div id="verified-kyc" class="stats-card stats-card-clickable">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h6 class="text-muted mb-2">KYC Verified</h6>
                            <h2 class="mb-0 text-dark"><?php echo e($verifiedKyc); ?></h2>
                            <div class="small text-info">
                                <i class="bi bi-info-circle"></i> 
                                <span id="pending-kyc-info"><?php echo e($pendingKyc); ?> pending verification</span>
                            </div>
                        </div>
                        <div class="flex-shrink-0 ms-3">
                            <div class="bg-light rounded-circle p-3">
                ...
                <div id="total-applications" class="stats-card stats-card-clickable">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-0 text-dark"><?php echo e(number_format($totalApplications)); ?></h2>
                            <div class="small text-success">
                                <i class="bi bi-arrow-up"></i> <?php echo e($applicationGrowth); ?>% from last month
                            </div>
                        </div>
                        <div class="flex-shrink-0 ms-3">
                            <div class="bg-light rounded-circle p-3">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <h4 class="mb-0 text-primary"><?php echo e(\App\Models\User::where('role', 'jobseeker')->count()); ?></h4>
                            </div>
                            <div class="progress" style="height: 6px;">
                                <div class="progress-bar bg-primary" style="width: <?php echo e($totalUsers > 0 ? (\App\Models\User::where('role', 'jobseeker')->count() / $totalUsers * 100) : 0); ?>%"></div>
                            </div>
                        </div>
                        ...
                        <div class="list-group-item">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <h4 class="mb-0 text-success"><?php echo e(\App\Models\User::where('role', 'employer')->count()); ?></h4>
                            </div>
                            <div class="progress" style="height: 6px;">
                                <div class="progress-bar bg-success" style="width: <?php echo e($totalUsers > 0 ? (\App\Models\User::where('role', 'employer')->count() / $totalUsers * 100) : 0); ?>%"></div>
                            </div>
                        </div>
                        ...
                        <div class="list-group-item">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <h4 class="mb-0 text-warning"><?php echo e(\App\Models\User::where('role', 'admin')->count()); ?></h4>
                            </div>
                            <div class="progress mb-3" style="height: 6px;">
                                <div class="progress-bar bg-warning" style="width: <?php echo e($totalUsers > 0 ? (\App\Models\User::where('role', 'admin')->count() / $totalUsers * 100) : 0); ?>%"></div>
                            </div>
                                        ...
                                        <div class="d-flex align-items-center py-2 border-top">
                                            <div class="flex-shrink-0">
                                                <?php if($admin->profile_photo): ?>
                                                    <img src="<?php echo e(asset('profile_img/' . $admin->profile_photo)); ?>" class="rounded-circle" width="32" height="32" alt="<?php echo e($admin->name); ?>">
                                                <?php else: ?>
                                                    <div class="bg-warning bg-opacity-25 rounded-circle d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;">
                                                        <span class="text-warning fw-bold"><?php echo e(substr($admin->name, 0, 1)); ?></span>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            <div class="flex-grow-1 ms-2">
                                                <div class="fw-semibold" style="font-size: 0.875rem;"><?php echo e($admin->name); ?></div>
                                                <small class="text-muted"><?php echo e($admin->email); ?></small>
                                            </div>
                                            <a href="<?php echo e(route('admin.users.show', $admin->id)); ?>" class="btn btn-sm btn-outline-secondary">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(\App\Models\User::where('role', 'admin')->count() > 5): ?>
                                        <div class="text-center mt-2">
                                            <a href="<?php echo e(route('admin.users.index', ['role' => 'admin'])); ?>" class="btn btn-sm btn-link">
                                                View all <?php echo e(\App\Models\User::where('role', 'admin')->count()); ?> admins
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                </div>
...
<script>
    ...
    new Chart(registrationCtx, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($registrationData->pluck('day')); ?>,
            datasets: [{
    ...
    function refreshDashboard() {
        ...
        fetch('<?php echo e(route('admin.dashboard.clear-cache')); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>