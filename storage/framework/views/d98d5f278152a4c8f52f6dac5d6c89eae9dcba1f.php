...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Create Resume - <?php echo e($template->name); ?></h4>
                <div class="page-title-right">
                    <a href="<?php echo e(route('account.resume-builder.index')); ?>" class="btn btn-secondary">
    ...
    <form action="<?php echo e(route('account.resume-builder.store')); ?>" method="POST" id="resumeForm" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="e.g., Software Developer Resume" required>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            <i class="mdi mdi-information"></i> Auto-filled from your profile (you can edit)
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="name" class="form-control" value="<?php echo e($personalInfo['name']); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Email</label>
                                <input type="email" name="email" class="form-control" value="<?php echo e($personalInfo['email']); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Phone</label>
                                <input type="text" name="phone" class="form-control" value="<?php echo e($personalInfo['phone']); ?>" placeholder="e.g., +1234567890">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Address</label>
                                <input type="text" name="address" class="form-control" value="<?php echo e($personalInfo['address']); ?>" placeholder="e.g., City, State">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Website (Optional)</label>
                                <input type="url" name="website" class="form-control" value="<?php echo e($personalInfo['website'] ?? ''); ?>" placeholder="e.g., www.yoursite.com">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Job Title</label>
                                <input type="text" name="job_title" class="form-control" placeholder="e.g., Graphics Designer" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="alert alert-info" style="font-size: 12px;">
                            <i class="mdi mdi-information"></i> Auto-filled from your profile bio
                        </div>
                        <textarea name="professional_summary" class="form-control" rows="4" placeholder="Brief overview of your professional background and career objectives..."><?php echo e($professionalSummary ?? ''); ?></textarea>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card sticky-top" style="top: 20px;">
                    <div class="card-body">
                        <h5 class="card-title mb-3">Template Preview</h5>
                        <div class="bg-light rounded mb-3 d-flex align-items-center justify-content-center" style="height: 200px;">
                            <div class="text-center text-muted">
                                ...
                                <p class="mt-2 mb-0"><?php echo e($template->name); ?></p>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn btn-success btn-block w-100">
                            <i class="mdi mdi-content-save"></i> Save Resume
                        </button>
                    </div>
                </div>
            </div>
...
let workExperiences = [];
let educations = <?php echo json_encode($education ?? [], 15, 512) ?>;
let skills = <?php echo json_encode($skills ?? [], 15, 512) ?>;
let certifications = [];
let languages = [];
let projects = [];
...
<?php echo $__env->make('layouts.jobseeker', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/front/account/resume-builder/create.blade.php ENDPATH**/ ?>