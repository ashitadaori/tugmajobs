...
<div class="profile-pro">
    ...
    <div class="profile-page-header">
        ...
        <div class="completion-badge">
            ...
            <span><?php echo e($completionPercentage ?? 0); ?>% Complete</span>
        </div>
    </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-3 text-center mb-3 mb-md-0">
                                <div class="profile-picture-preview">
                                    <?php if($user->image): ?>
                                        <img src="<?php echo e(asset('profile_img/thumb/'.$user->image)); ?>"
                                             alt="Profile Picture"
                        ...
                        <form action="<?php echo e(route('account.updateProfile')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="<?php echo e(old('name', $user->name)); ?>" placeholder="Enter your full name">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control" value="<?php echo e(old('email', $user->email)); ?>" placeholder="Enter your email">
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="phone" class="mb-2">Phone</label>
                                    <input type="tel" name="phone" id="phone" class="form-control" value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="Enter your phone number">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="designation" id="designation" class="form-control" value="<?php echo e(old('designation', $user->jobSeekerProfile->current_job_title ?? '')); ?>" placeholder="e.g., Senior Software Engineer">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea name="bio" id="bio" class="form-control" rows="4" placeholder="Tell employers about yourself, your experience and career goals"><?php echo e(old('bio', $user->jobSeekerProfile->professional_summary ?? '')); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <div class="skills-input-container">
                                        ...
                                        ?>
                                        <input type="hidden" name="skills" id="skillsHidden" value="<?php echo e(old('skills', $skillsValue)); ?>">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div id="experienceList">
                            <?php if($user->jobSeekerProfile && isset($user->jobSeekerProfile->work_experience) && is_array($user->jobSeekerProfile->work_experience)): ?>
                                <?php $__currentLoopData = $user->jobSeekerProfile->work_experience; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $experience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div class="experience-item mb-3 p-3 border rounded">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <p class="mb-1"><?php echo e($experience['company'] ?? ''); ?></p>
                                                <p class="text-muted mb-2"><?php echo e($experience['start_date'] ?? ''); ?> - <?php echo e($experience['end_date'] ?? 'Present'); ?></p>
                                                <p class="mb-0"><?php echo e($experience['description'] ?? ''); ?></p>
                                            </div>
                                            <div>
                                                <button class="btn btn-sm btn-outline-primary me-2 edit-experience" 
                                                    data-experience="<?php echo e(json_encode($experienceWithIndex)); ?>">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger delete-experience" data-index="<?php echo e($index); ?>">
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div id="educationList">
                            <?php if($user->jobSeekerProfile && isset($user->jobSeekerProfile->education) && is_array($user->jobSeekerProfile->education)): ?>
                                <?php $__currentLoopData = $user->jobSeekerProfile->education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div class="education-item mb-3 p-3 border rounded">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h5 class="mb-1"><?php echo e($education['degree'] ?? ''); ?></h5>
                                                <p class="mb-1"><?php echo e($education['school'] ?? ''); ?></p>
                                                <p class="text-muted mb-0"><?php echo e($education['start_date'] ?? ''); ?> - <?php echo e($education['end_date'] ?? 'Present'); ?></p>
                                            </div>
                                            <div>
                                                <button class="btn btn-sm btn-outline-primary me-2 edit-education" 
                                                    data-education="<?php echo e(json_encode($educationWithIndex)); ?>">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger delete-education" data-index="<?php echo e($index); ?>">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                            </div>
                                        </div>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body p-4">
                    ...
                    <p class="mb-4 text-muted small">Upload your latest resume or CV document</p>
                        ...
                        <form action="<?php echo e(route('account.uploadResume')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
                                <?php if($user->jobSeekerProfile && $user->jobSeekerProfile->resume_file): ?>
                                    <div class="current-resume mb-3">
                                        <p class="mb-2">Current Resume:</p>
                                        <div class="d-flex align-items-center">
                                            <i class="fas fa-file-pdf me-2"></i>
                                            <span><?php echo e(basename($user->jobSeekerProfile->resume_file)); ?></span>
                                            <a href="<?php echo e(asset('storage/'.$user->jobSeekerProfile->resume_file)); ?>" 
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body p-4">
                    ...
                    <p class="mb-4 text-muted small">Set your job preferences to receive personalized job recommendations</p>
                        ...
                        <form action="<?php echo e(route('account.updateProfile')); ?>" method="post" id="jobPreferencesForm">
                            <?php echo csrf_field(); ?>
                            ...
                            ?>
                            <input type="hidden" name="designation" value="<?php echo e($currentJobTitle); ?>">
                            <input type="hidden" name="bio" value="<?php echo e($professionalSummary); ?>">
                            <input type="hidden" name="skills" value="<?php echo e($profileSkills); ?>">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input category-checkbox" type="checkbox" 
                                                           name="preferred_categories[]" value="<?php echo e($category->id); ?>"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="custom-dropdown-container position-relative" id="jobTypesDropdownContainer">
                                        ...
                                        <div class="custom-dropdown-menu" id="jobTypesDropdownMenu" style="display: none; position: absolute; top: 100%; left: 0; right: 0; z-index: 1000; background: white; border: 1px solid #ced4da; border-radius: 0.375rem; padding: 0.75rem; max-height: 250px; overflow-y: auto; box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15);">
                                            ...
                                            ?>
                                            <?php $__currentLoopData = $jobTypesFromDB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input job-type-checkbox" type="checkbox" 
                                                           name="preferred_job_types[]" value="<?php echo e($jobType->id); ?>"
                                                           id="job_type_<?php echo e($jobType->id); ?>"
                                                           <?php echo e(in_array($jobType->id, $selectedJobTypes) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label" for="job_type_<?php echo e($jobType->id); ?>">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="experience_level" id="experience_level" class="form-select">
                                        ...
                                        <option value="entry" <?php echo e(old('experience_level', $user->jobSeekerProfile->experience_level ?? '') == 'entry' ? 'selected' : ''); ?>>Entry Level (0-2 years)</option>
                                        <option value="mid" <?php echo e(old('experience_level', $user->jobSeekerProfile->experience_level ?? '') == 'mid' ? 'selected' : ''); ?>>Mid Level (2-5 years)</option>
                                        <option value="senior" <?php echo e(old('experience_level', $user->jobSeekerProfile->experience_level ?? '') == 'senior' ? 'selected' : ''); ?>>Senior Level (5-8 years)</option>
                                        <option value="lead" <?php echo e(old('experience_level', $user->jobSeekerProfile->experience_level ?? '') == 'lead' ? 'selected' : ''); ?>>Lead/Expert (8+ years)</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" name="salary_expectation_min" id="salary_expectation_min"
                                           class="form-control" value="<?php echo e(old('salary_expectation_min', $user->jobSeekerProfile->expected_salary_min ?? '')); ?>"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" name="salary_expectation_max" id="salary_expectation_max"
                                           class="form-control" value="<?php echo e(old('salary_expectation_max', $user->jobSeekerProfile->expected_salary_max ?? '')); ?>"
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body p-4">
                    ...
                    <p class="mb-4 text-muted small">Add your professional social media and portfolio links</p>
                        ...
                        <form action="<?php echo e(route('account.updateSocialLinks')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="url" name="social_links[linkedin]" id="linkedin" class="form-control"
                                           value="<?php echo e(old('social_links.linkedin', ($user->jobSeekerProfile ? $user->jobSeekerProfile->linkedin_url : ''))); ?>"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="url" name="social_links[github]" id="github" class="form-control"
                                           value="<?php echo e(old('social_links.github', ($user->jobSeekerProfile ? $user->jobSeekerProfile->github_url : ''))); ?>"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="url" name="social_links[portfolio]" id="portfolio" class="form-control"
                                           value="<?php echo e(old('social_links.portfolio', ($user->jobSeekerProfile ? $user->jobSeekerProfile->portfolio_url : ''))); ?>"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="url" name="social_links[facebook]" id="facebook" class="form-control"
                                           value="<?php echo e(old('social_links.facebook', ($user->jobSeekerProfile ? $user->jobSeekerProfile->facebook_url : ''))); ?>"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="url" name="social_links[twitter]" id="twitter" class="form-control"
                                           value="<?php echo e(old('social_links.twitter', ($user->jobSeekerProfile ? $user->jobSeekerProfile->twitter_url : ''))); ?>"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="url" name="social_links[instagram]" id="instagram" class="form-control"
                                           value="<?php echo e(old('social_links.instagram', ($user->jobSeekerProfile ? $user->jobSeekerProfile->instagram_url : ''))); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.profile-completion-checklist','data' => ['user' => Auth::user(),'completionPercentage' => $completionPercentage ?? 0]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('profile-completion-checklist'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(Auth::user()),'completionPercentage' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($completionPercentage ?? 0)]); ?>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo e(route('account.resume-builder.index')); ?>" class="btn btn-outline-success">
                            <i class="fas fa-file-pdf me-2"></i>Build Resume
                        </a>
                        <a href="<?php echo e(route('account.myJobApplications')); ?>" class="btn btn-outline-info">
                            <i class="fas fa-file-alt me-2"></i>My Applications
                        </a>
                        <a href="<?php echo e(route('account.settings')); ?>" class="btn btn-outline-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (saveExperienceBtn) {
        saveExperienceBtn.addEventListener('click', function() {
            ...
            const url = editingExperienceId !== null ? '<?php echo e(route("account.updateExperience")); ?>' : '<?php echo e(route("account.addExperience")); ?>';
    ...
    if (saveEducationBtn) {
        saveEducationBtn.addEventListener('click', function() {
            ...
            const url = editingEducationId !== null ? '<?php echo e(route("account.updateEducation")); ?>' : '<?php echo e(route("account.addEducation")); ?>';
    ...
    window.deleteExperience = function(experienceIndex) {
        if (confirm('Are you sure you want to delete this experience?')) {
            ...
            fetch('<?php echo e(route("account.deleteExperience")); ?>', {
                method: 'POST',
                body: formData
            })
            .then(response => {
    ...
    window.deleteEducation = function(educationIndex) {
        if (confirm('Are you sure you want to delete this education?')) {
            ...
            fetch('<?php echo e(route("account.deleteEducation")); ?>', {
                method: 'POST',
                body: formData
            })
            .then(response => {
    ...
    if (profileImageForm) {
        ...
        profileImageForm.addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route("account.updateProfileimg")); ?>', {
                method: 'POST',
                body: formData
            })
    ...
    if (removeImageBtn) {
        removeImageBtn.addEventListener('click', function() {
            if (confirm('Are you sure you want to remove your profile picture?')) {
                ...
                fetch('<?php echo e(route("account.removeProfileImage")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.jobseeker', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/front/account/my-profile.blade.php ENDPATH**/ ?>