...
<?php $__env->startSection('page_title', 'Analytics'); ?>
    ...
    <div class="metrics-grid">
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <span class="metric-value" id="totalViewsValue"><?php echo e(number_format($totalViews ?? 0)); ?></span>
                <span class="metric-change <?php echo e(($viewsChange ?? 0) >= 0 ? 'positive' : 'negative'); ?>" id="viewsChange">
                    <i class="bi bi-arrow-<?php echo e(($viewsChange ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
                    <?php echo e(abs($viewsChange ?? 0)); ?>% from last period
                </span>
            </div>
        </div>
        ...
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <span class="metric-value" id="totalApplicationsValue"><?php echo e(number_format($totalApplications ?? 0)); ?></span>
                <span class="metric-change <?php echo e(($applicationsChange ?? 0) >= 0 ? 'positive' : 'negative'); ?>" id="applicationsChange">
                    <i class="bi bi-arrow-<?php echo e(($applicationsChange ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
                    <?php echo e(abs($applicationsChange ?? 0)); ?>% from last period
                </span>
            </div>
        </div>
        ...
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <span class="metric-value" id="conversionRateValue"><?php echo e($conversionRate ?? '0'); ?>%</span>
        ...
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <span class="metric-value"><?php echo e($avgTimeToHire ?? 14); ?> days</span>
                <span class="metric-change positive">
                ...
                <div class="chart-card">
                    ...
                    <div class="chart-body">
                        <div class="top-jobs-list" id="topJobsList">
                            <?php $__empty_1 = true; $__currentLoopData = $topJobs ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="top-job-item">
                                    <div class="job-info">
                                        <h6 class="job-title"><?php echo e($job['title'] ?? 'Job Title'); ?></h6>
                                        <small class="job-date">Posted <?php echo e($job['created_at'] ? $job['created_at']->diffForHumans() : 'recently'); ?></small>
                                    </div>
                                    <div class="job-stats">
                                        <span class="job-apps"><?php echo e($job['applications_count'] ?? 0); ?></span>
                    ...
                    <div class="funnel-list">
                        <div class="funnel-item">
                            ...
                            <div class="funnel-info">
                                ...
                                <span class="funnel-value"><?php echo e($funnelData['applications'] ?? 0); ?></span>
                            </div>
                        </div>
                        <div class="funnel-item">
                            ...
                            <div class="funnel-info">
                                ...
                                <span class="funnel-value"><?php echo e($funnelData['screening'] ?? 0); ?></span>
                            </div>
                        </div>
                        <div class="funnel-item">
                            ...
                            <div class="funnel-info">
                                ...
                                <span class="funnel-value"><?php echo e($funnelData['interviews'] ?? 0); ?></span>
                            </div>
                        </div>
                        <div class="funnel-item">
                            ...
                            <div class="funnel-info">
                                ...
                                <span class="funnel-value"><?php echo e($funnelData['offers'] ?? 0); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="performance-section">
        <div class="chart-card">
            ...
            <div class="chart-body p-0">
                <?php if($jobPerformanceBreakdown->isEmpty()): ?>
                    <div class="empty-state">
                        <i class="bi bi-briefcase"></i>
                        <h6>No Jobs Posted Yet</h6>
                        <p>Post your first job to see performance analytics</p>
                        <a href="<?php echo e(route('employer.jobs.create')); ?>" class="btn btn-primary btn-sm">
                ...
                <?php else: ?>
                    <div class="table-responsive">
                        <table class="table performance-table" id="performanceTable">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $jobPerformanceBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <div class="job-cell">
                                            <span class="job-name"><?php echo e($job['title']); ?></span>
                                            <small class="job-id">ID: #<?php echo e($job['id']); ?></small>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <span class="stat-value"><?php echo e(number_format($job['views'])); ?></span>
                                    </td>
                                    <td class="text-center">
                                        <span class="stat-value"><?php echo e(number_format($job['applications'])); ?></span>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge <?php echo e($job['conversion_rate'] >= 10 ? 'bg-success' : ($job['conversion_rate'] >= 5 ? 'bg-warning text-dark' : 'bg-secondary')); ?>">
                                            <?php echo e($job['conversion_rate']); ?>%
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <div class="date-cell">
                                            <span class="date-main"><?php echo e($job['posted_date']->format('M d, Y')); ?></span>
                                            <small class="date-ago"><?php echo e($job['posted_date']->diffForHumans()); ?></small>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge <?php echo e($job['status'] == 'active' ? 'bg-success' : 'bg-secondary'); ?>">
                                            <?php echo e(ucfirst($job['status'])); ?>

                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <?php if($job['views_trend'] > 0): ?>
                                            <span class="trend-badge up">
                                                <i class="bi bi-arrow-up"></i> <?php echo e($job['views_trend']); ?>%
                                            </span>
                                        <?php elseif($job['views_trend'] < 0): ?>
                                            <span class="trend-badge down">
                                                <i class="bi bi-arrow-down"></i> <?php echo e(abs($job['views_trend'])); ?>%
                                            </span>
                                        <?php else: ?>
                    ...
                    <div class="performance-summary">
                        <div class="summary-item">
                            <span class="summary-value text-primary"><?php echo e(number_format($totalViews)); ?></span>
                            <span class="summary-label">Total Views</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-value text-success"><?php echo e(number_format($totalApplications)); ?></span>
                            <span class="summary-label">Total Applications</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-value text-info"><?php echo e($conversionRate); ?>%</span>
                            <span class="summary-label">Avg Conversion</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-value text-warning"><?php echo e($jobPerformanceBreakdown->count()); ?></span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const originalData = {
        totalViews: <?php echo e($totalViews ?? 0); ?>,
        totalApplications: <?php echo e($totalApplications ?? 0); ?>,
        conversionRate: <?php echo e($conversionRate ?? 0); ?>,
        avgTimeToHire: <?php echo e($avgTimeToHire ?? 0); ?>,
        viewsChange: <?php echo e($viewsChange ?? 0); ?>,
        applicationsChange: <?php echo e($applicationsChange ?? 0); ?>

    };

    // Initial data from server
    const initialApplicationTrends = <?php echo json_encode($applicationTrends ?? [], 15, 512) ?>;
    const initialApplicationSources = <?php echo json_encode($applicationSources ?? [], 15, 512) ?>;
    ...
    function loadAnalyticsData(range) {
        ...
        fetch(`<?php echo e(route('employer.analytics.data')); ?>?range=${range}`)
            ...
            .then(data => {
                ...
                return fetch(`<?php echo e(route('employer.analytics.sources')); ?>?range=${range}`);
            })
            .then(response => response.json())
            .then(sourcesData => {
...
<?php echo $__env->make('layouts.employer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/front/account/employer/analytics/index.blade.php ENDPATH**/ ?>