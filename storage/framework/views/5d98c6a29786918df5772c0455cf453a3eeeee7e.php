...
<?php $__env->startSection('page-title', 'Saved Jobs'); ?>
...
<div class="saved-jobs-pro">
    ...
    <div class="saved-jobs-hero">
        <div class="hero-content">
            ...
            <div class="saved-count-badge">
                <div class="count-number"><?php echo e($savedJobs->total()); ?></div>
    ...
    <?php if($savedJobs->count() > 0): ?>
        ...
        <div class="saved-jobs-list">
            <?php $__currentLoopData = $savedJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $savedJob): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($savedJob->job): ?>
                <div class="saved-job-card" data-job-id="<?php echo e($savedJob->job->id); ?>">
                    <div class="company-logo">
                        <?php if($savedJob->job->company && $savedJob->job->company->logo): ?>
                            <img src="<?php echo e(asset('storage/' . $savedJob->job->company->logo)); ?>" alt="<?php echo e($savedJob->job->company->name); ?>">
                        <?php elseif($savedJob->job->employer && $savedJob->job->employer->image): ?>
                            <img src="<?php echo e(asset('profile_img/' . $savedJob->job->employer->image)); ?>" alt="<?php echo e($savedJob->job->employer->name); ?>">
                        <?php else: ?>
                            <i class="fas fa-building"></i>
                        <?php endif; ?>
                    </div>
                    <div class="job-content">
                        <a href="<?php echo e(route('jobDetail', $savedJob->job->id)); ?>" class="job-title">
                            <?php echo e($savedJob->job->title); ?>

                        </a>
                        <p class="company-name">
                            <i class="fas fa-building"></i>
                            <?php echo e($savedJob->job->company->name ?? $savedJob->job->employer->name ?? 'Company'); ?>

                        </p>
                        <div class="job-meta">
                            <span class="meta-item">
                                <i class="fas fa-map-marker-alt"></i>
                                <?php echo e($savedJob->job->location ?? 'Location not specified'); ?>

                            </span>
                            <span class="meta-item">
                                <i class="fas fa-briefcase"></i>
                                <?php echo e($savedJob->job->jobType->name ?? 'N/A'); ?>

                            </span>
                            <?php if($savedJob->job->salary_min && $savedJob->job->salary_max): ?>
                            <span class="meta-item">
                                <i class="fas fa-peso-sign"></i>
                                <?php echo e(number_format($savedJob->job->salary_min)); ?> - <?php echo e(number_format($savedJob->job->salary_max)); ?>
                    ...
                    <div class="job-actions">
                        <a href="<?php echo e(route('jobDetail', $savedJob->job->id)); ?>" class="btn-view">
                            <i class="fas fa-eye"></i> View Job
                        </a>
                        <button type="button" class="btn-remove remove-saved-job" data-job-id="<?php echo e($savedJob->job->id); ?>">
                            <i class="fas fa-trash-alt"></i> Remove
                        </button>
                        <?php if($savedJob->job->applications_count > 0): ?>
                        <span class="applicant-count"><?php echo e($savedJob->job->applications_count); ?> applicants</span>
                        <?php endif; ?>
                    </div>
                </div>
                <?php endif; ?>
    ...
    <?php else: ?>
        ...
        <div class="empty-state-saved">
            ...
            <a href="<?php echo e(route('jobs')); ?>" class="btn-browse">
...
<?php echo $__env->make('layouts.jobseeker', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/front/account/jobseeker/saved-jobs.blade.php ENDPATH**/ ?>