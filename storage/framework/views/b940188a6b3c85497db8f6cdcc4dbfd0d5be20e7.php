...
<div class="ep-welcome-banner">
    ...
    <p class="ep-welcome-subtitle"><?php echo e(now()->format('l, F j, Y')); ?> - Here's what's happening with your recruitment.</p>
    <?php if(auth()->user()->canPostJobs()): ?>
    <div class="ep-welcome-actions">
        <a href="<?php echo e(route('employer.jobs.create')); ?>" class="ep-welcome-btn ep-welcome-btn-primary">
            <i class="bi bi-plus-circle"></i>
            Post New Job
        </a>
        <a href="<?php echo e(route('employer.applications.index')); ?>" class="ep-welcome-btn ep-welcome-btn-outline">
            <i class="bi bi-eye"></i>
            View Applications
        </a>
    </div>
...
<div class="ep-stats-grid">
    ...
    <div class="ep-stat-card primary">
        ...
        <div class="ep-stat-value" data-count="<?php echo e($postedJobs); ?>"><?php echo e($postedJobs); ?></div>
        <div class="ep-stat-change <?php echo e(($postedJobsGrowth ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
            <i class="bi bi-arrow-<?php echo e(($postedJobsGrowth ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
            <?php echo e(abs($postedJobsGrowth ?? 0)); ?>% from last month
        </div>
        <a href="<?php echo e(route('employer.jobs.index')); ?>" class="ep-stat-link">
    ...
    <div class="ep-stat-card success">
        ...
        <div class="ep-stat-value" data-count="<?php echo e($activeJobs); ?>"><?php echo e($activeJobs); ?></div>
        <div class="ep-stat-change <?php echo e(($activeJobsGrowth ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
            <i class="bi bi-arrow-<?php echo e(($activeJobsGrowth ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
            <?php echo e(abs($activeJobsGrowth ?? 0)); ?>% from last month
        </div>
        <a href="<?php echo e(route('employer.jobs.index', ['status' => 'active'])); ?>" class="ep-stat-link">
    ...
    <div class="ep-stat-card info">
        ...
        <div class="ep-stat-value" data-count="<?php echo e($totalApplications); ?>"><?php echo e($totalApplications); ?></div>
        <div class="ep-stat-change <?php echo e(($applicationsGrowth ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
            <i class="bi bi-arrow-<?php echo e(($applicationsGrowth ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
            <?php echo e(abs($applicationsGrowth ?? 0)); ?>% from last month
        </div>
        <a href="<?php echo e(route('employer.applications.index')); ?>" class="ep-stat-link">
    ...
    <div class="ep-stat-card warning">
        ...
        <div class="ep-stat-value" data-count="<?php echo e($pendingApplications ?? 0); ?>"><?php echo e($pendingApplications ?? 0); ?></div>
        <div class="ep-stat-change" style="color: var(--ep-warning);">
            <i class="bi bi-exclamation-triangle-fill"></i>
            Needs attention
        </div>
        <a href="<?php echo e(route('employer.applications.index', ['status' => 'pending'])); ?>" class="ep-stat-link">
    ...
    <div class="ep-dashboard-main">
        ...
        <div class="ep-card">
            <div class="ep-card-header">
                ...
                <a href="<?php echo e(route('employer.jobs.index')); ?>" class="ep-btn ep-btn-outline ep-btn-sm">
                    View All
                </a>
            </div>
            <div class="ep-card-body" style="padding: 0;">
                ...
                <div class="ep-job-item">
                    ...
                    <div class="ep-job-info">
                        <div class="ep-job-title"><?php echo e(Str::limit($job->title, 40)); ?></div>
                        <div class="ep-job-meta">
                            <span class="ep-badge ep-badge-<?php echo e($job->status == 'active' ? 'success' : ($job->status == 'pending' ? 'warning' : 'gray')); ?>">
                                <?php echo e(ucfirst($job->status)); ?>

                            </span>
                            <span><i class="bi bi-geo-alt"></i> <?php echo e($job->location ?? 'Remote'); ?></span>
                            <span><i class="bi bi-clock"></i> <?php echo e($job->created_at->diffForHumans()); ?></span>
                        </div>
                    </div>
                    <div class="ep-job-stats">
                        <span><i class="bi bi-eye"></i> <?php echo e($job->views ?? 0); ?></span>
                        <span><i class="bi bi-people"></i> <?php echo e($job->applications_count ?? 0); ?></span>
                    </div>
                    <div class="ep-job-actions">
                        <a href="<?php echo e(route('employer.jobs.show', $job->id)); ?>" class="ep-btn ep-btn-icon ep-btn-outline" title="View">
                            <i class="bi bi-eye"></i>
                        </a>
                        <a href="<?php echo e(route('employer.jobs.edit', $job->id)); ?>" class="ep-btn ep-btn-icon ep-btn-outline" title="Edit">
        ...
        <div class="ep-quick-stats ep-mb-6">
            ...
            <div class="ep-quick-stat-item">
                ...
                <div class="ep-quick-stat-info">
                    ...
                    <div class="ep-quick-stat-value"><?php echo e($profileViews ?? 0); ?></div>
                </div>
            </div>
            ...
            <div class="ep-quick-stat-item">
                ...
                <div class="ep-quick-stat-info">
                    ...
                    <div class="ep-quick-stat-value">
                        ...
                        ?>
                        <?php echo e(number_format($rating, 1)); ?> <span style="color: #fbbf24; font-size: 0.9em;">★</span>
                    </div>
                </div>
            </div>
            ...
            <div class="ep-quick-stat-item">
                ...
                <div class="ep-quick-stat-info">
                    ...
                    <div class="ep-quick-stat-value"><?php echo e($shortlistedCandidates ?? 0); ?></div>
                </div>
            </div>
        </div>
            ...
            <div class="ep-card-body">
                <div style="margin-bottom: 16px;">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                        <span style="font-weight: 600; color: var(--ep-gray-800);"><?php echo e($profileCompletion); ?>% Complete</span>
                    </div>
                    <div style="height: 8px; background: var(--ep-gray-200); border-radius: 9999px; overflow: hidden;">
                        <div style="height: 100%; width: <?php echo e($profileCompletion); ?>%; background: linear-gradient(90deg, var(--ep-primary), var(--ep-primary-light)); border-radius: 9999px; transition: width 0.5s ease;"></div>
                    </div>
                </div>

                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <i class="bi bi-<?php echo e($completionItems['company_info'] ? 'check-circle-fill' : 'circle'); ?>" style="color: <?php echo e($completionItems['company_info'] ? 'var(--ep-success)' : 'var(--ep-gray-400)'); ?>;"></i>
                        <span style="font-size: 14px; color: var(--ep-gray-700);">Company Information</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <i class="bi bi-<?php echo e($completionItems['contact_details'] ? 'check-circle-fill' : 'circle'); ?>" style="color: <?php echo e($completionItems['contact_details'] ? 'var(--ep-success)' : 'var(--ep-gray-400)'); ?>;"></i>
                        <span style="font-size: 14px; color: var(--ep-gray-700);">Contact Details</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <i class="bi bi-<?php echo e($completionItems['company_logo'] ? 'check-circle-fill' : 'circle'); ?>" style="color: <?php echo e($completionItems['company_logo'] ? 'var(--ep-success)' : 'var(--ep-gray-400)'); ?>;"></i>
                        <span style="font-size: 14px; color: var(--ep-gray-700);">Company Logo</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <i class="bi bi-<?php echo e($completionItems['culture_benefits'] ? 'check-circle-fill' : 'circle'); ?>" style="color: <?php echo e($completionItems['culture_benefits'] ? 'var(--ep-success)' : 'var(--ep-gray-400)'); ?>;"></i>
                        <span style="font-size: 14px; color: var(--ep-gray-700);">Culture & Benefits</span>
                    </div>
                </div>

                <?php if($profileCompletion < 100): ?>
                <a href="<?php echo e(route('employer.profile.edit')); ?>" class="ep-btn ep-btn-outline-primary" style="width: 100%; margin-top: 16px;">
                    <i class="bi bi-pencil"></i>
                    Complete Profile
                </a>
                <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (ctx) {
        const labels = <?php echo json_encode($applicationTrendsLabels ?? [], 15, 512) ?>;
        const data = <?php echo json_encode($applicationTrendsData ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.employer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/front/account/employer/dashboard.blade.php ENDPATH**/ ?>