                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-7 p-5 position-relative bg-white">
                        ...
                        <div id="loginForm" class="auth-form">
                            ...
                            <!-- Google Login Button -->
                            <div class="mb-4">
                                <a href="<?php echo e(route('social.redirect', ['provider' => 'google', 'role' => 'jobseeker'])); ?>" class="btn btn-outline-secondary w-100 social-btn google-btn d-flex align-items-center justify-content-center">
                            ...
                            <form method="POST" action="<?php echo e(route('login')); ?>" class="needs-validation" novalidate>
                                ...
                                <div class="mb-3" id="loginPasswordField" style="display: none;">
                                    <label for="loginPassword" class="form-label fw-semibold text-dark d-flex justify-content-between align-items-center">
                                        <span>Password</span>
                                        <a href="<?php echo e(route('account.forgotPassword')); ?>" class="text-decoration-none text-primary small">
                                            Forgot password?
                                        </a>
                                    </label>
                                    <input type="password"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php if($errors->has('name') || $errors->has('password_confirmation') || $errors->has('role')): ?>
        switchToRegister();
    <?php endif; ?>
});
<?php endif; ?>
</script><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/components/auth-modal.blade.php ENDPATH**/ ?>