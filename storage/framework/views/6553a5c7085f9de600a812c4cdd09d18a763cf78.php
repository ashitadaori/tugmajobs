...
function loadQuickActionsData() {
    fetch('<?php echo e(route('admin.quick-actions.dashboard')); ?>')
        .then(res => res.json())
        .then(data => {
...
function loadPendingJobs() {
    fetch('<?php echo e(route('admin.jobs.pending')); ?>?ajax=1')
        .then(res => res.json())
        .then(data => {
...
function bulkApproveJobs() {
    ...
    fetch('<?php echo e(route('admin.quick-actions.bulk-approve-jobs')); ?>', {
        method: 'POST',
        headers: {
...
function confirmBulkReject() {
    ...
    fetch('<?php echo e(route('admin.quick-actions.bulk-reject-jobs')); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
...
function loadPendingKyc() {
    ...
    fetch('<?php echo e(route('admin.users.index')); ?>?kyc_status=in_progress&ajax=1')
        .then(res => res.json())
        .then(data => {
...
function bulkVerifyKyc() {
    ...
    fetch('<?php echo e(route('admin.quick-actions.bulk-verify-kyc')); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
...
function handleMassEmail(e) {
    ...
    fetch('<?php echo e(route('admin.quick-actions.send-mass-email')); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
...
<?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/admin/partials/quick-actions.blade.php ENDPATH**/ ?>