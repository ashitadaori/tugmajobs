...
<head>
    ...
    <script src="<?php echo e(asset('assets/js/dynamic-interactions.js')); ?>"></script>
    ...
    <style>
        ...
        body {
            ...
            color: #374151; /* Clear readable dark gray */
        ...
        .btn {
            font-size: 1.125rem; /* Larger button text for all buttons */
            font-weight: 500;
        ...
        .dropdown-item {
            ...
            font-weight: 500;
            font-size: 1.125rem; /* Larger dropdown text */
            color: var(--text-dark);
            border-radius: var(--radius-sm);
            transition: all 0.2s ease;
            line-height: 1.5;
        ...
        .alert {
            border: none;
            border-radius: var(--radius);
            padding: 1.25rem 1.5rem; /* Larger padding for better readability */
            margin-bottom: 1.5rem;
            font-size: 1.125rem; /* Larger alert text */
            font-weight: 500;
            line-height: 1.5;
        }
        ...
        .badge {
            padding: 0.5rem 0.875rem; /* Larger badge padding */
            font-weight: 500;
            font-size: 0.875rem; /* Larger badge text */
            border-radius: var(--radius-sm);
            line-height: 1;
        }
        ...
        .form-control {
            font-size: 1.125rem; /* Larger form text */
            padding: 0.875rem 1rem; /* Larger form padding */
        ...
        .table {
            font-size: 1.125rem; /* Larger table text */
        }

        .table th {
            font-weight: 600;
            color: var(--text-dark);
            padding: 1rem 1.25rem; /* Larger table padding */
        }
        ...
        /* Enhanced breadcrumb */
        .breadcrumb-item {
            font-size: 1.125rem; /* Larger breadcrumb text */
        }

        /* Enhanced pagination */
        .page-link {
            font-size: 1.125rem; /* Larger pagination text */
            padding: 0.75rem 1rem; /* Larger pagination padding */
            min-height: 44px;
        }
...
<body class="<?php if(request()->routeIs('home') || request()->has('force_home')): ?> homepage <?php endif; ?> <?php if(request()->routeIs('jobs') || request()->routeIs('jobs.*')): ?> jobs-page <?php endif; ?> <?php if(request()->routeIs('companies') || request()->routeIs('companies.*')): ?> companies-page <?php endif; ?> <?php if(request()->has('force_home')): ?> force-home <?php endif; ?>">
    <?php if(auth()->guard()->check()): ?>
    ...
    <div class="main-content">
        <?php if(request()->routeIs('home') || request()->has('force_home')): ?>
    ...
    <script src="<?php echo e(asset('assets/js/kyc-status-refresher.js')); ?>"></script>
    
    <!-- Homepage KYC Banner Remover Script -->
    <script src="<?php echo e(asset('assets/js/homepage-kyc-banner-remover.js')); ?>"></script>
    ...
    <?php if(session('info')): ?>
        showToast('<?php echo e(session('info')); ?>', 'success');
    <?php endif; ?>
    </script>
</body>
</html>
<?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/front/layouts/app.blade.php ENDPATH**/ ?>