            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-3">
                    <h5 class="reviewer-name mb-1">
                        ...
                        <?php if($review->user->jobSeekerProfile && $review->user->jobSeekerProfile->is_kyc_verified): ?>
                    ...
                    <div class="review-meta">
                        ...
                        <?php if($review->review_type === 'company' && $review->job): ?>
        ...
        <div class="employer-response">
            <div class="response-header">
                ...
                <span class="text-muted ms-2">
                    <?php echo e($review->employer_responded_at->diffForHumans()); ?>

                </span>
            </div>
            <p class="response-text mb-0"><?php echo e($review->employer_response); ?></p>
        </div>
    <?php endif; ?>
    
    <div class="review-footer">
        <button class="btn btn-sm btn-outline-secondary helpful-btn" data-review-id="<?php echo e($review->id); ?>" onclick="markHelpful(<?php echo e($review->id); ?>)">
            <i class="far fa-thumbs-up me-1"></i>
            Helpful (<?php echo e($review->helpful_count); ?>)
        </button>
        
        <?php if(auth()->guard()->check()): ?>
            <?php if(Auth::id() === $review->user_id): ?>
                <div class="ms-auto">
                    <?php if($review->created_at->diffInDays(now()) <= 30): ?>
                        <button class="btn btn-sm btn-outline-primary" onclick="editReview(<?php echo e($review->id); ?>)">
                            <i class="fas fa-edit me-1"></i>Edit
                        </button>
                    <?php endif; ?>
                    <button class="btn btn-sm btn-outline-danger" onclick="deleteReview(<?php echo e($review->id); ?>)">
...
<?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/components/review-card.blade.php ENDPATH**/ ?>