...
<?php $__env->startSection('page_title', 'Post New Job'); ?>
...
<div class="job-form-container">
    ...
    <?php if(\App\Models\MaintenanceSetting::isMaintenanceActive('employer')): ?>
        <div class="alert alert-warning text-center mb-4">
            ...
            <p class="mb-3"><?php echo e(\App\Models\MaintenanceSetting::getMaintenanceMessage('employer')); ?></p>
            <a href="<?php echo e(route('employer.dashboard')); ?>" class="btn btn-primary">
    ...
    <div class="job-create-header mb-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-md-end">
                <a href="<?php echo e(route('employer.jobs.index')); ?>" class="btn btn-outline-secondary btn-lg">
    ...
    <div class="card job-form-card">
        <div class="card-body">
            <form id="jobForm" action="<?php echo e(route('employer.jobs.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" required 
                                       placeholder="e.g. Senior Software Developer" value="<?php echo e(old('title')); ?>">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="job_type_id" name="job_type_id" required>
                                    ...
                                    <?php if(isset($jobTypes) && $jobTypes->count() > 0): ?>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="vacancy" name="vacancy" required 
                                       min="1" max="100" value="<?php echo e(old('vacancy', 1)); ?>">
                ...
                <div class="wizard-section" id="step-2" style="display: none;">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="6" required 
                                  maxlength="5000" placeholder="Describe the role, responsibilities, and what makes this position exciting..."><?php echo e(old('description')); ?></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="experience_level" name="experience_level" required>
                                    ...
                                    <option value="entry" <?php echo e(old('experience_level') == 'entry' ? 'selected' : ''); ?>>Entry Level (0-2 years)</option>
                                    <option value="intermediate" <?php echo e(old('experience_level') == 'intermediate' ? 'selected' : ''); ?>>Intermediate Level (3-5 years)</option>
                                    <option value="expert" <?php echo e(old('experience_level') == 'expert' ? 'selected' : ''); ?>>Expert Level (6+ years)</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="education_level" name="education_level">
                                    ...
                                    <option value="vocational" <?php echo e(old('education_level') == 'vocational' ? 'selected' : ''); ?>>Vocational/Technical</option>
                                    <option value="associate" <?php echo e(old('education_level') == 'associate' ? 'selected' : ''); ?>>Associate Degree</option>
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="salary_min" name="salary_min" 
                                           placeholder="15,000" value="<?php echo e(old('salary_min')); ?>">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="salary_max" name="salary_max" 
                                           placeholder="50,000" value="<?php echo e(old('salary_max')); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="deadline" name="deadline" 
                               min="<?php echo e(date('Y-m-d')); ?>" value="<?php echo e(old('deadline')); ?>">
...
- Honest and trustworthy"><?php echo e(old('qualifications')); ?></textarea>
                        <div class="character-counter"></div>
...
- With valid professional driver's license"><?php echo e(old('requirements')); ?></textarea>
                        <div class="character-counter"></div>
...
- Health insurance
- 13th month pay
- Paid leave"><?php echo e(old('benefits')); ?></textarea>
                        <div class="character-counter"></div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" id="skills" name="skills" value="<?php echo e(old('skills')); ?>">
                    ...
                    <div class="mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="requires_screening" name="requires_screening"
                                       <?php echo e(old('requires_screening') ? 'checked' : ''); ?>>
                        ...
                        <div id="preliminary_questions_container" style="display: none;">
                            ...
                            <input type="hidden" id="preliminary_questions" name="preliminary_questions" value="<?php echo e(old('preliminary_questions')); ?>">
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="job-preview">
                                ...
                                <p class="text-muted mb-2">
                                    <i class="fas fa-building me-2"></i><span id="preview-company"><?php echo e(Auth::user()->employerProfile->company_name ?? Auth::user()->name); ?></span>
...
<script src="<?php echo e(asset('assets/js/job-form-wizard-fixed.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/preliminary-questions.js')); ?>"></script>
...
<?php echo $__env->make('layouts.employer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/front/account/employer/jobs/create.blade.php ENDPATH**/ ?>