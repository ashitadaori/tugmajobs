    ...
    <div class="welcome-header-pro">
        <div class="content">
            <div class="welcome-text">
                <h1>Welcome back, <?php echo e(Auth::check() ? explode(' ', Auth::user()->name)[0] : 'Guest'); ?>!</h1>
                <p>
            ...
            <div class="completion-ring-wrapper">
                ...
                <div class="ring-container">
                    <svg viewBox="0 0 56 56">
                        <circle class="ring-bg" cx="28" cy="28" r="<?php echo e($radius); ?>"/>
                        <circle class="ring-progress" cx="28" cy="28" r="<?php echo e($radius); ?>"
                                stroke-dasharray="<?php echo e($circumference); ?>" stroke-dashoffset="<?php echo e($offset); ?>"/>
                    </svg>
                    <span class="ring-value"><?php echo e($percentage); ?>%</span>
                </div>
                <div class="ring-info">
                    <span class="ring-label">Profile</span>
                    <span class="ring-status"><?php echo e($percentage >= 100 ? 'Complete' : 'In Progress'); ?></span>
                </div>
            </div>
        </div>
    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.kyc-status-card','data' => ['user' => Auth::user()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('kyc-status-card'); ?>
...
<?php endif; ?>
    ...
    <div class="stats-grid-dashboard">
        <div class="stat-card-dashboard primary">
            ...
            <div class="stat-number"><?php echo e($stats['applications'] ?? 0); ?></div>
            <div class="stat-label">Total Applications</div>
            <a href="<?php echo e(route('account.myJobApplications')); ?>" class="stat-link">
        ...
        <div class="stat-card-dashboard pink">
            ...
            <div class="stat-number"><?php echo e($stats['saved_jobs'] ?? 0); ?></div>
            <div class="stat-label">Saved Jobs</div>
            <a href="<?php echo e(route('account.saved-jobs.index')); ?>" class="stat-link">
                View all <i class="fas fa-arrow-right"></i>
            </a>
        </div>
        ...
        <div class="stat-card-dashboard cyan">
            ...
            <div class="stat-number"><?php echo e($stats['profile_views'] ?? 0); ?></div>
            <div class="stat-label">Profile Views</div>
            <a href="<?php echo e(route('account.analytics')); ?>" class="stat-link">
        ...
        <div class="stat-card-dashboard green">
            ...
            <div class="stat-number"><?php echo e($completionPercentage ?? 0); ?>%</div>
            <div class="stat-label">Profile Complete</div>
            <a href="<?php echo e(route('account.myProfile')); ?>" class="stat-link">
    ...
    <div class="section-header-dashboard">
        ...
        <a href="<?php echo e(route('account.myJobApplications')); ?>" class="view-all">
            View All <i class="fas fa-arrow-right"></i>
        </a>
    </div>
        ...
        <?php $__currentLoopData = $recentApplications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="application-item-dashboard">
                <div class="company-logo">
                    <?php if($application->job->company && $application->job->company->logo): ?>
                        <img src="<?php echo e(asset('storage/' . $application->job->company->logo)); ?>" alt="Logo">
                    <?php else: ?>
                        <i class="fas fa-building"></i>
                    <?php endif; ?>
                </div>
                <div class="job-info">
                    <a href="<?php echo e(route('jobDetail', $application->job->id)); ?>" class="job-title">
                        <?php echo e($application->job->title ?? 'Job Position'); ?>

                    </a>
                    <p class="company-name">
                        <?php echo e($application->job->company->name ?? $application->job->employer->name ?? 'Company'); ?>

                    </p>
                    <span class="applied-date">
                        <i class="far fa-calendar me-1"></i>Applied <?php echo e($application->created_at->diffForHumans()); ?>
                ...
                <div>
                    ...
                    <?php elseif($application->status == 'approved' || $application->status == 'accepted'): ?>
    ...
    <div class="empty-state-dashboard">
        ...
        <a href="<?php echo e(route('jobs')); ?>" class="btn-primary">
    ...
    <div class="quick-actions-dashboard">
        <a href="<?php echo e(route('account.resume-builder.index')); ?>" class="quick-action-card purple">
        ...
        <a href="<?php echo e(route('account.saved-jobs.index')); ?>" class="quick-action-card pink">
            <div class="action-icon">
                <i class="fas fa-bookmark"></i>
            </div>
        ...
        <a href="<?php echo e(route('account.analytics')); ?>" class="quick-action-card cyan">
            <div class="action-icon">
        ...
        <a href="<?php echo e(route('account.myProfile')); ?>" class="quick-action-card orange">
            <div class="action-icon">
...
<?php echo $__env->make('layouts.jobseeker', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/front/account/dashboard.blade.php ENDPATH**/ ?>