...
<?php $__env->startSection('page-title', 'Application Details - ' . $application->job->title); ?>

<?php $__env->startSection('jobseeker-content'); ?>
<div class="application-detail-page">
    
    <div class="mb-4">
        <a href="<?php echo e(route('account.myJobApplications')); ?>" class="btn btn-outline-secondary">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h3 class="mb-2"><?php echo e($application->job->title); ?></h3>
                    <div class="d-flex flex-wrap gap-3 text-muted">
                        <span><i class="fas fa-building me-1"></i> <?php echo e($application->job->company->name ?? $application->job->employer->employerProfile->company_name ?? 'Company'); ?></span>
                        <span><i class="fas fa-map-marker-alt me-1"></i> <?php echo e($application->job->location); ?></span>
                        <span><i class="fas fa-briefcase me-1"></i> <?php echo e($application->job->jobType->name ?? 'Full-time'); ?></span>
                    </div>
                    <div class="mt-2">
                        <small class="text-muted">
                            <i class="fas fa-calendar me-1"></i> Applied <?php echo e($application->applied_date ? $application->applied_date->format('M d, Y') : $application->created_at->format('M d, Y')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
                    ...
                    <div class="progress-tracker">
                        ...
                        <div class="d-flex justify-content-between position-relative">
                            ...
                            <?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <div class="progress-step text-center <?php echo e($isCompleted ? 'completed' : ''); ?> <?php echo e($isCurrent ? 'current' : ''); ?> <?php echo e($isRejected && $index == 0 ? 'rejected' : ''); ?>">
                                    <div class="step-icon <?php echo e($isCompleted ? 'bg-success text-white' : ($isCurrent ? ($application->stage_status === 'rejected' ? 'bg-danger text-white' : 'bg-primary text-white') : 'bg-light text-muted')); ?>">
                                        <i class="fas <?php echo e($stage['icon']); ?>"></i>
                                    </div>
                                    <div class="step-label mt-2"><?php echo e($stage['name']); ?></div>
                                </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0"><i class="fas fa-comments me-2 text-primary"></i> Messages & Updates from Employer</h5>
                </div>
                <div class="card-body p-0">
                        ...
                        <div class="timeline">
                            <?php $__currentLoopData = $application->statusHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="timeline-item">
                                    <div class="timeline-marker bg-<?php echo e($color); ?>">
                                        <i class="fas <?php echo e($icon); ?> text-white"></i>
                                    </div>
                                    <div class="timeline-content">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <h6 class="mb-0 fw-bold text-<?php echo e($color); ?>">
                                                <?php echo e(ucwords(str_replace('_', ' ', $history->status))); ?>

                                            </h6>
                                            <small class="text-muted">
                                                <i class="far fa-clock me-1"></i>
                                                <?php echo e($history->created_at->format('M d, Y h:i A')); ?>

                                            </small>
                                        </div>
                                        <?php if($history->notes): ?>
                                            <div class="message-box p-2 rounded <?php echo e($color === 'danger' ? 'bg-danger-subtle' : ($color === 'success' ? 'bg-success-subtle' : 'bg-light')); ?>">
                                                <p class="mb-0">
                                        ...
                                        <?php endif; ?>
                                        <?php if($history->updatedByUser): ?>
                                            <small class="text-muted d-block mt-2">
                                                <i class="fas fa-user me-1"></i> Updated by: <?php echo e($history->updatedByUser->name); ?>
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">No messages or updates yet. The employer will update your application soon.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="col-lg-4">
                    ...
                    <div class="card-body py-2 px-3">
                        <div class="interview-detail-item">
                            ...
                            <div class="detail-content">
                                ...
                                <span class="detail-value"><?php echo e($application->interview_date ? $application->interview_date->format('l, M d, Y') : 'TBD'); ?></span>
                            </div>
                        </div>
                        <div class="interview-detail-item">
                            ...
                            <div class="detail-content">
                                ...
                                <span class="detail-value">
                                    <?php if($application->interview_time): ?>
                                        <?php echo e(\Carbon\Carbon::parse($application->interview_time)->format('h:i A')); ?>
                        ...
                        <div class="interview-detail-item">
                            ...
                            <div class="detail-content">
                                ...
                                <span class="detail-value"><?php echo e($application->getInterviewTypeName()); ?></span>
                            </div>
                        </div>
                        <?php if($application->interview_type === 'video_call'): ?>
                            <div class="interview-detail-item">
                                ...
                                <div class="detail-content">
                                    ...
                                    <?php if($application->interview_location): ?>
                                        <a href="<?php echo e($application->interview_location); ?>" target="_blank" class="btn btn-sm btn-primary mt-1">
                        ...
                        <?php else: ?>
                            <div class="interview-detail-item">
                                ...
                                <div class="detail-content">
                                    ...
                                    <span class="detail-value"><?php echo e($application->interview_location ?? 'TBD'); ?></span>
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if($application->interview_notes): ?>
                            <div class="interview-notes mt-2">
                                ...
                                <div class="notes-content"><?php echo e($application->interview_notes); ?></div>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <?php if($application->stage === 'requirements'): ?>
                <div class="card border-0 shadow-sm mb-4 border-start border-4 border-warning">
                    <div class="card-header bg-warning bg-opacity-10 border-bottom">
                        <h5 class="mb-0 text-warning"><i class="fas fa-file-upload me-2"></i> Document Submission Required</h5>
                    </div>
                    <div class="card-body">
                        <?php if($application->job->jobRequirements && $application->job->jobRequirements->count() > 0): ?>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                        <div>
                                            ...
                                            <?php if($requirement->description): ?>
                                                <small class="d-block text-muted"><?php echo e($requirement->description); ?></small>
                                            <?php endif; ?>
                                        </div>
                                        <?php if($submitted): ?>
                            ...
                            <?php if($application->stage_status === 'pending'): ?>
                                <a href="<?php echo e(route('job.submitRequirements', $application->id)); ?>" class="btn btn-warning w-100">
                                    <i class="fas fa-upload me-2"></i> Submit Documents Now
                                </a>
                            <?php elseif($application->stage_status === 'approved'): ?>
                        ...
                        <?php else: ?>
                            ...
                            <div class="text-center py-3">
                                ...
                                <?php if($application->stage_status === 'pending'): ?>
                                    <a href="<?php echo e(route('job.submitRequirements', $application->id)); ?>" class="btn btn-success">
            ...
            <?php elseif($application->job->jobRequirements && $application->job->jobRequirements->count() > 0): ?>
                        ...
                        <?php $__currentLoopData = $application->job->jobRequirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requirement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="document-item">
                                <div class="document-info">
                                    <div class="document-icon <?php echo e($submitted ? 'submitted' : 'pending'); ?>">
                                        <i class="fas <?php echo e($submitted ? 'fa-file-check' : 'fa-file'); ?>"></i>
                                    </div>
                                    <span class="document-name"><?php echo e($requirement->name); ?></span>
                                </div>
                                <span class="document-status <?php echo e($submitted ? 'submitted' : 'not-required'); ?>">
                                    <i class="fas <?php echo e($submitted ? 'fa-check-circle' : 'fa-minus-circle'); ?>"></i>
                                    <?php echo e($submitted ? 'Submitted' : 'Not Required'); ?>
            ...
            <div class="card summary-card border-0 shadow-sm mb-3">
                ...
                <div class="card-body py-0 px-3">
                    <div class="summary-item">
                        ...
                        ?>
                        <span class="summary-status-badge <?php echo e($statusClass); ?>"><?php echo e($stageName); ?></span>
                    </div>
                    <div class="summary-item">
                        <div class="summary-left">
                        ...
                        <span class="summary-value"><?php echo e($application->applied_date ? $application->applied_date->format('M d, Y') : $application->created_at->format('M d, Y')); ?></span>
                    </div>
                    <div class="summary-item">
                        <div class="summary-left">
                        ...
                        <span class="summary-value"><?php echo e($application->updated_at->format('M d, Y')); ?></span>
                    </div>
                    <?php if($application->resume): ?>
                        <div class="summary-item resume-item">
                            ...
                            <a href="<?php echo e(asset('storage/' . $application->resume)); ?>" target="_blank" class="resume-btn">
            ...
            <a href="<?php echo e(route('jobDetail', $application->job_id)); ?>" class="view-job-btn">
...
<?php echo $__env->make('layouts.jobseeker', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/front/account/job/application-detail.blade.php ENDPATH**/ ?>