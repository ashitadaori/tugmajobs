...
<?php foreach($attributes->onlyProps(['user', 'completionPercentage' => 0]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['user', 'completionPercentage' => 0]); ?>
<?php foreach (array_filter((['user', 'completionPercentage' => 0]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<div class="profile-completion-checklist">
    <div class="checklist-header">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <span class="completion-badge"><?php echo e($completedItems); ?>/<?php echo e($totalItems); ?></span>
        </div>
        ...
        <div class="checklist-progress">
            ...
            <small class="text-muted mt-1 d-block"><?php echo e($completionRate); ?>% Complete</small>
        </div>
        ...
        <?php elseif($completionRate >= 80 && $completionRate < 100): ?>
    ...
    <div class="checklist-items">
        ...
        <div class="checklist-item <?php echo e($item['completed'] ? 'completed' : ''); ?>">
            <div class="item-icon">
                <?php if($item['completed']): ?>
                    <i class="fas fa-check-circle text-success"></i>
                <?php else: ?>
                    <i class="<?php echo e($item['icon']); ?> text-muted"></i>
                <?php endif; ?>
            </div>
            <div class="item-content">
                <h6 class="item-title"><?php echo e($item['title']); ?></h6>
                <p class="item-description"><?php echo e($item['description']); ?></p>
            </div>
            <div class="item-action">
                <?php if(!$item['completed']): ?>
                    <a href="<?php echo e($item['route']); ?>" class="btn btn-sm btn-outline-primary">
                        Complete
                    </a>
                <?php else: ?>
...
<?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/components/profile-completion-checklist.blade.php ENDPATH**/ ?>