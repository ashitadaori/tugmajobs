<div class="dropdown employer-notif-wrapper">
    <button type="button" class="employer-notif-bell-btn <?php echo e(Auth::user()->unreadNotificationsCount > 0 ? 'has-unread' : ''); ?>" id="notificationDropdown" data-bs-toggle="dropdown" aria-expanded="false">
        <i class="bi bi-bell"></i>
        <?php if(Auth::user()->unreadNotificationsCount > 0): ?>
            <span class="employer-notif-badge"><?php echo e(Auth::user()->unreadNotificationsCount); ?></span>
        <?php endif; ?>
    </button>
    
    <div class="dropdown-menu dropdown-menu-end employer-notif-dropdown" aria-labelledby="notificationDropdown" style="position: absolute !important;">
        <!-- Header -->
        ...
        <div class="employer-notif-list" id="employerNotifList">
            <?php $__empty_1 = true; $__currentLoopData = Auth::user()->notifications()->latest()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <a href="<?php echo e($redirectUrl); ?>"
                   class="employer-notif-item <?php echo e(is_null($notification->read_at) ? 'emp-notif-unread' : ''); ?>"
                   data-notification-id="<?php echo e($notification->id); ?>"
                   data-redirect-url="<?php echo e($redirectUrl); ?>">
                    <div class="employer-notif-icon">
                        <i class="bi <?php echo e($iconClass); ?>" style="color: <?php echo e($iconColor); ?>;"></i>
                    </div>
                    <div class="employer-notif-content">
                        ...
                        <div class="employer-notif-message">
                            <?php echo e($notification->message ?? ($data['message'] ?? 'New notification')); ?>
        ...
        <div class="employer-notif-footer">
            <a href="<?php echo e(route('notifications.index')); ?>" class="employer-notif-view-all">
            ...
            $(document).on('click', '.employer-notif-item', function(e) {
                ...
                if (isUnread && notificationId) {
                    ...
                    $.ajax({
                        ...
                        complete: function() {
                            // Redirect after marking (or attempting to mark)
                            if (redirectUrl) {
...
<?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/components/notification-dropdown.blade.php ENDPATH**/ ?>