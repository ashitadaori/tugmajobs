...
<div class="analytics-dashboard">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card stat-warning">
            ...
            <div class="stat-details">
                <span class="stat-value"><?php echo e($pendingApplications); ?></span>
        ...
        <div class="stat-card stat-success">
            ...
            <div class="stat-details">
                <span class="stat-value"><?php echo e($acceptedApplications); ?></span>
        ...
        <div class="stat-card stat-danger">
            ...
            <div class="stat-details">
                <span class="stat-value"><?php echo e($rejectedApplications); ?></span>
    ...
    <div class="profile-stats-grid">
        <div class="profile-stat-card">
            ...
            <div class="profile-stat-content">
                <span class="profile-stat-value"><?php echo e($totalProfileViews); ?></span>
        ...
        <div class="profile-stat-card">
            ...
            <div class="profile-stat-content">
                <span class="profile-stat-value"><?php echo e($profileViewsThisWeek); ?></span>
        ...
        <div class="profile-stat-card">
            ...
            <div class="profile-stat-content">
                <span class="profile-stat-value"><?php echo e($profileViewsThisMonth); ?></span>
            ...
            <div class="metrics-content">
                ...
                <div class="metric-item">
                    <div class="metric-header">
                        ...
                        <span class="metric-percentage <?php echo e($acceptanceRate >= 20 ? 'text-success' : ($acceptanceRate >= 10 ? 'text-warning' : 'text-muted')); ?>">
                            <?php echo e($acceptanceRate); ?>%
                        </span>
                    </div>
                    <div class="metric-bar">
                        <div class="metric-fill success" style="width: <?php echo e(min($acceptanceRate, 100)); ?>%"></div>
                    </div>
                </div>
                ...
                <div class="metric-item">
                    <div class="metric-header">
                        ...
                        <span class="metric-percentage text-warning"><?php echo e($pendingRate); ?>%</span>
                    </div>
                    <div class="metric-bar">
                        <div class="metric-fill warning" style="width: <?php echo e(min($pendingRate, 100)); ?>%"></div>
                    </div>
                </div>
                ...
                <div class="metric-item">
                    <div class="metric-header">
                        ...
                        <span class="metric-percentage text-danger"><?php echo e($rejectionRate); ?>%</span>
                    </div>
                    <div class="metric-bar">
                        <div class="metric-fill danger" style="width: <?php echo e(min($rejectionRate, 100)); ?>%"></div>
                    </div>
                </div>
    ...
    <div class="section-header">
        ...
        <a href="<?php echo e(route('account.myJobApplications')); ?>" class="view-all-link">
        ...
        <div class="applications-list">
            ...
            <div class="application-row">
                <div class="application-main">
                    <h4 class="job-title"><?php echo e($application->job->title ?? 'Job Title Not Available'); ?></h4>
                    <div class="job-meta">
                        <span class="job-category">
                            <i class="fas fa-folder"></i>
                            <?php echo e($application->job->category->name ?? 'Uncategorized'); ?>
                ...
                <div class="application-status">
                    <span class="status-pill status-<?php echo e(strtolower($application->status ?? 'pending')); ?>">
            ...
            <div class="empty-state">
                ...
                <a href="<?php echo e(route('jobs')); ?>" class="btn-primary-action">
    ...
    <div class="viewers-card">
        <div class="viewers-list">
            <?php $__empty_1 = true; $__currentLoopData = $recentProfileViewers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="viewer-row">
                <div class="viewer-avatar">
                    <?php if($view->viewer && $view->viewer->employerProfile && $view->viewer->employerProfile->logo): ?>
                        <img src="<?php echo e(asset('storage/' . $view->viewer->employerProfile->logo)); ?>" alt="<?php echo e($view->viewer->name); ?>">
                    <?php else: ?>
                ...
                <div class="viewer-details">
                    <h4 class="viewer-name">
                        <?php echo e($view->viewer->name ?? 'Anonymous Employer'); ?>

                        <?php if($view->viewer_type === 'employer'): ?>
                            <span class="employer-badge">Employer</span>
                        <?php endif; ?>
                    </h4>
                    <p class="viewer-company">
                        <?php if($view->viewer && $view->viewer->employerProfile): ?>
                            <?php echo e($view->viewer->employerProfile->company_name ?? 'Company'); ?>
                ...
                <div class="viewer-meta">
                    <span class="view-time">
                        <i class="fas fa-clock"></i>
                        <?php echo e($view->viewed_at->diffForHumans()); ?>

                    </span>
                    <?php if($view->source): ?>
                        <span class="view-source">
                            via <?php echo e(ucfirst(str_replace('_', ' ', $view->source))); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(trendsCtx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Applications',
                data: <?php echo json_encode($applicationTrends->pluck('count')); ?>,
    ...
    new Chart(statusCtx, {
        ...
        data: {
            ...
            datasets: [{
                data: [<?php echo e($pendingApplications); ?>, <?php echo e($acceptedApplications); ?>, <?php echo e($rejectedApplications); ?>],
                backgroundColor: [
    ...
    new Chart(categoryCtx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Applications',
                data: <?php echo json_encode($categoryStats->pluck('count')); ?>,
                backgroundColor: [
...
<?php echo $__env->make('layouts.jobseeker', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/front/account/analytics.blade.php ENDPATH**/ ?>