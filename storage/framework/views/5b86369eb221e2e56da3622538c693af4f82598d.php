<?php $__env->startSection('page_title', 'Analytics Dashboard'); ?>
                ...
                <div class="analytics-card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 class="mb-0"><?php echo e(number_format($stats['total_jobs'])); ?></h3>
                        </div>
                ...
                <div class="analytics-card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 class="mb-0"><?php echo e(number_format($stats['total_jobseekers'])); ?></h3>
                        </div>
                ...
                <div class="analytics-card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 class="mb-0"><?php echo e(number_format($stats['verified_jobseekers'])); ?></h3>
                        </div>
...
<script>
    ...
    async function loadClusterData() {
        ...
        try {
            const response = await fetch(`<?php echo e(route('admin.analytics.clusters')); ?>?k=${k}`);
    ...
    async function loadSkillTrends() {
        ...
        try {
            const response = await fetch(`<?php echo e(route('admin.analytics.skills')); ?>?days=${days}`);
            const result = await response.json();
    ...
    async function loadMapData() {
        ...
        try {
            const response = await fetch(`<?php echo e(route('admin.analytics.map')); ?>?category_id=${categoryId}`);
            const result = await response.json();
    ...
    async function loadHeatmapData() {
        ...
        try {
            const response = await fetch('<?php echo e(route('admin.analytics.density')); ?>');
            const result = await response.json();
    ...
    async function loadJobFairData() {
        ...
        try {
            const response = await fetch(`<?php echo e(route('admin.analytics.jobfair')); ?>?industry=${industry}`);
            const result = await response.json();
    ...
    function refreshAllData() {
        // Clear cache first
        fetch('<?php echo e(route('admin.analytics.clear-cache')); ?>', { method: 'POST', headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' } })
            .then(() => {
                loadClusterData();
    ...
    function exportReport() {
        window.location.href = '<?php echo e(route('admin.analytics.export')); ?>';
    }
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\capstoneeeeeee\Capstone\job-portal-main\resources\views/admin/peso-analytics/index.blade.php ENDPATH**/ ?>