                ...
                <div class="card h-100 shadow-sm hover-card">
                    <div class="card-body">
                        ...
                        <div class="btn-group w-100 mb-2">
                            <a href="{{ route('admin.company-management.show', $company) }}" 
                               class="btn btn-outline-primary">
                                <i class="bi bi-eye"></i> View
                            </a>
                            <a href="{{ route('admin.company-management.edit', $company) }}" 
                               class="btn btn-outline-warning">
                                <i class="bi bi-pencil"></i> Edit
                            </a>
                        </div>

                        <form action="{{ route('admin.company-management.destroy', $company) }}" 
                              method="POST" 
