...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-1">Create Hiring Poster</h1>
                <p class="text-muted">Fill in the details to generate your hiring poster</p>
            </div>
                        ...
                        <form id="posterForm">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="alert alert-info small py-2">
                                    ...
                                    Template auto-rotates. Current: <strong>{{ $template->name }}</strong>
                                </div>
                                <div class="row g-2">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="requirements" name="requirements" rows="4"
                                    ...
                                    required></textarea>
                                <small class="text-muted">Tip: Keep it to 3-5 key requirements for best results</small>
                            ...
                            <div class="mb-4">
                                <a class="btn btn-link p-0 text-decoration-none" data-bs-toggle="collapse"
                                    ...
                                    <i class="bi bi-plus-circle me-1"></i>Additional Details (Optional)
                                </a>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="collapse mt-3" id="customizationFields">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label for="primary_color" class="form-label">Primary Color</label>
                                            <div class="input-group">
                                                <input type="color" class="form-control form-control-color"
                                                    id="primary_color" name="primary_color" value="#0d6efd"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="color" class="form-control form-control-color"
                                                    id="secondary_color" name="secondary_color" value="#ffffff"
                                                    title="Choose your color">
                    ...
                    <div class="card-body">
                        <div id="posterPreview" class="poster-live-preview">
                            <div class="preview-placeholder text-center py-5">
                                ...
                                <p class="text-muted mt-2">Fill in the form to see preview</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function updatePreview() {
                    ...
                    `;
                        ...
                        <div class="preview-blue">
                            <div style="text-align: center; margin-bottom: 15px;">
                                <div style="background: #fbbf24; color: #000; padding: 8px 25px; font-weight: bold; display: inline-block;">WE ARE</div>
                                <div style="font-size: 3rem; font-weight: 900; margin-top: 5px;">HIRING</div>
                            </div>
                            <div style="margin: 15px 0;">
                                <p style="font-weight: bold; margin: 0 0 5px;">Title:</p>
                                <p style="font-size: 1.2rem; font-weight: bold; margin: 0;">${title}</p>
                            ...
                            <div style="margin: 15px 0;">
                                <div style="background: #fbbf24; color: #000; padding: 4px 10px; display: inline-block; font-size: 0.75rem; font-weight: bold; margin-bottom: 8px;">REQUIREMENT:</div>
                                <div style="font-size: 0.85rem; line-height: 1.7; white-space: pre-line;">${reqs}</div>
                            </div>
                            <div style="margin-top: 20px; display: flex; justify-content: space-between; align-items: center;">
                                <span style="font-weight: bold;">${company}</span>
                                <span style="background: #fbbf24; color: #000; padding: 8px 18px; font-size: 0.75rem; font-weight: bold; border-radius: 20px;">Apply Now</span>
                            </div>
                        </div>
                    `;
                    }
                ...
                form.addEventListener('submit', function (e) {
                    ...
                    fetch('{{ route("admin.posters.store") }}', {
                        method: 'POST',
                        headers: {
