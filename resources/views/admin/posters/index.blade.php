                                ...
                                <div class="card h-100 poster-card">
                                    <div class="card-body">
                                        <div class="poster-preview mb-3 p-3 rounded" style="background: linear-gradient(135deg,
                                                    ...
                                                    @elseif($poster->template->slug == 'minimalist-green') #10b981, #059669
                                                    @elseif($poster->template->slug == 'gradient-purple') #6D28D9, #4C1D95
                                                    @else #1F2937, #374151
                                                    @endif);">
                                            <div class="text-center text-white">
                                                <small class="d-block mb-1 fw-bold">WE ARE HIRING</small>
                                                <strong class="d-block"
                                                    style="font-size: 0.9rem;">{{ Str::limit($poster->job_title, 20) }}</strong>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer bg-transparent">
                                        <div class="btn-group w-100" role="group">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-danger delete-poster"
                                                data-id="{{ $poster->id }}">
