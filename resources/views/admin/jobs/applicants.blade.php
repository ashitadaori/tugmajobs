                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-2 text-center">
                                    @php
                                        $profileImageUrl = $application->user->profile_image;
                                        if (!$profileImageUrl) {
                                            $profileImageUrl = asset('images/default-profile.svg');
                                        }
                                    @endphp
                                    <img src="{{ $profileImageUrl }}" alt="{{ $application->user->name }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-muted mb-2">
                                        ...
                                        <i class="bi bi-telephone"></i> {{ $application->user->phone ?? 'N/A' }}
                                    </p>
                                ...
                                <div class="col-md-2 text-center">
                                    ...
                                    @if($application->resume)
                                        <a href="{{ asset('storage/' . $application->resume) }}"
                                            class="btn btn-sm btn-outline-secondary mb-2 w-100" target="_blank">
