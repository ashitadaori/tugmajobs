...
<body>
    ...
    <div class="content">
        <p>Hello <strong>{{ $mailData['employer_name'] }}</strong>,</p>
        
        <p>Great news! You have received a new application for your job posting.</p>
        
        <div class="detail-box">
            <div class="detail-label">Job Position</div>
            <div class="detail-value">{{ $mailData['job_title'] }}</div>
        </div>
        
        <div class="detail-box">
            <div class="detail-label">Applicant Name</div>
            <div class="detail-value">{{ $mailData['applicant_name'] }}</div>
        </div>
        
        <div class="detail-box">
            <div class="detail-label">Applicant Email</div>
            <div class="detail-value">{{ $mailData['applicant_email'] }}</div>
        </div>
