        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar">
                ...
                <nav class="nav flex-column">
                    ...
                    <a href="{{ route('admin.jobs.create') }}" class="nav-link nav-link-success {{ request()->routeIs('admin.jobs.create') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.company-management.index') }}" class="nav-link {{ request()->routeIs('admin.company-management.*') ? 'active' : '' }}">
                        <i class="bi bi-building me-2"></i> Company Management
                    </a>
                    <a href="{{ route('admin.companies.index') }}" class="nav-link {{ request()->routeIs('admin.companies.*') && !request()->routeIs('admin.company-management.*') ? 'active' : '' }}">
                        <i class="bi bi-briefcase me-2"></i> Employer Accounts
                    </a>
                    <a href="{{ route('admin.jobs.pending') }}" class="nav-link {{ request()->routeIs('admin.jobs.pending') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.kyc.didit-verifications') }}" class="nav-link {{ request()->routeIs('admin.kyc.*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.employers.documents.index') }}" class="nav-link {{ request()->routeIs('admin.employers.documents.*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.posters.index') }}" class="nav-link {{ request()->routeIs('admin.posters.*') ? 'active' : '' }}">
