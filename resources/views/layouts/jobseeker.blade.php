...
<head>
    ...
    <link href="{{ asset('assets/css/jobseeker-professional.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/css/jobseeker-zoom-fix.css') }}" rel="stylesheet">
...
<body class="modern-jobseeker-body @if(request()->routeIs('home') || request()->has('force_home')) homepage @endif @if(request()->routeIs('jobs') || request()->routeIs('jobs.*')) jobs-page @endif @if(request()->routeIs('companies') || request()->routeIs('companies.*')) companies-page @endif @if(request()->has('force_home')) force-home @endif">
    @include('components.maintenance-banner')
    
    @auth
        {{-- KYC banner removed as requested --}}
        {{-- @unless(request()->routeIs('home') || request()->has('force_home') || request()->routeIs('jobs') || request()->routeIs('jobs.*') || request()->routeIs('companies') || request()->routeIs('companies.*'))
...
<div class="modern-jobseeker-layout">
    ...
    <aside class="js-sidebar" id="jobseekerSidebar">
        ...
        <div class="js-sidebar-brand">
            <a href="{{ route('home') }}" class="js-brand-link">
        ...
        <div class="js-sidebar-profile">
            <a href="{{ route('account.myProfile') }}" class="js-profile-link">
                @if($user && $user->image)
                    <img src="{{ asset('profile_img/thumb/' . $user->image) }}" alt="Profile" class="js-profile-avatar">
                @else
                ...
                <div class="js-profile-info">
                    <h6 class="js-profile-name">{{ $user ? $user->name : 'Guest' }}</h6>
        ...
        <nav class="js-sidebar-nav">
            ...
            <div class="js-nav-section">
                ...
                <ul class="js-nav-list">
                    <li class="js-nav-item">
                        <a href="{{ route('account.dashboard') }}" class="js-nav-link {{ request()->routeIs('account.dashboard') ? 'active' : '' }}" data-tooltip="Dashboard">
                            <i class="fas fa-chart-line"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    <li class="js-nav-item">
                        <a href="{{ route('account.analytics') }}" class="js-nav-link {{ request()->routeIs('account.analytics') ? 'active' : '' }}" data-tooltip="Analytics">
            ...
            <div class="js-nav-section">
                ...
                <ul class="js-nav-list">
                    <li class="js-nav-item">
                        <a href="{{ route('jobs') }}" class="js-nav-link {{ request()->routeIs('jobs') || request()->routeIs('jobs.*') ? 'active' : '' }}" data-tooltip="Find Jobs">
                            <i class="fas fa-search"></i>
                            <span>Find Jobs</span>
                        </a>
                    </li>
                    <li class="js-nav-item">
                        <a href="{{ route('account.myJobApplications') }}" class="js-nav-link {{ request()->routeIs('account.myJobApplications') ? 'active' : '' }}" data-tooltip="Applications">
                            <i class="fas fa-file-alt"></i>
                            <span>Applications</span>
                            @if($applicationsCount > 0)
                                <span class="js-nav-badge">{{ $applicationsCount }}</span>
                            @endif
                        </a>
                    </li>
                    <li class="js-nav-item">
                        <a href="{{ route('account.saved-jobs.index') }}" class="js-nav-link {{ request()->routeIs('account.saved-jobs.*') ? 'active' : '' }}" data-tooltip="Saved Jobs">
                            <i class="fas fa-bookmark"></i>
                            <span>Saved Jobs</span>
                            @if($savedCount > 0)
                                <span class="js-nav-badge">{{ $savedCount }}</span>
                            @endif
                        </a>
                    </li>
                </ul>
            ...
            <div class="js-nav-section">
                ...
                <ul class="js-nav-list">
                    <li class="js-nav-item">
                        <a href="{{ route('account.myProfile') }}" class="js-nav-link {{ request()->routeIs('account.myProfile') ? 'active' : '' }}" data-tooltip="My Profile">
                            <i class="fas fa-user"></i>
                            <span>My Profile</span>
                        </a>
                    </li>
                    <li class="js-nav-item">
                        <a href="{{ route('account.resume-builder.index') }}" class="js-nav-link {{ request()->routeIs('account.resume-builder.*') ? 'active' : '' }}" data-tooltip="Resume Builder">
            ...
            <div class="js-nav-section">
                ...
                <ul class="js-nav-list">
                    <li class="js-nav-item">
                        <a href="{{ route('account.settings') }}" class="js-nav-link {{ request()->routeIs('account.settings') ? 'active' : '' }}" data-tooltip="Account Settings">
                            <i class="fas fa-cog"></i>
                            <span>Account Settings</span>
                        </a>
                    </li>
                    <li class="js-nav-item">
                        <a href="{{ route('account.changePassword') }}" class="js-nav-link {{ request()->routeIs('account.changePassword') ? 'active' : '' }}" data-tooltip="Change Password">
