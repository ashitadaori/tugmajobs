...
@section('jobseeker-content')
                    ...
                    <div class="chart-title-group">
                        <h3 class="chart-title">
                            ...
                            <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="This chart shows the number of job applications you have submitted over the last 30 days.">
                                <i class="fas fa-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                            </span>
                        </h3>
                ...
                <div class="chart-header">
                    <div class="chart-title-group">
                        <h3 class="chart-title">
                            Status Overview
                            <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="This chart shows the distribution of your application statuses (Pending, Accepted, Rejected).">
                                <i class="fas fa-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                            </span>
                        </h3>
                ...
                <div class="chart-header">
                    <div class="chart-title-group">
                        <h3 class="chart-title">
                            Top Categories
                            <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="This chart shows the industries (categories) where you have applied the most.">
                                <i class="fas fa-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                            </span>
                        </h3>
                ...
                <div class="chart-header">
                    <div class="chart-title-group">
                        <h3 class="chart-title">
                            Performance Metrics
                            <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Key success metrics including your Acceptance Rate, Pending Rate, and Rejection Rate.">
                                <i class="fas fa-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                            </span>
                        </h3>
                ...
                <div class="metrics-content">
                    ...
                    <div class="metric-item">
                        <div class="metric-header">
                            ...
                            <span
                                class="metric-percentage {{ $acceptanceRate >= 20 ? 'text-success' : ($acceptanceRate >= 10 ? 'text-warning' : 'text-muted') }}">
                                {{ $acceptanceRate }}%
                            </span>
                        </div>
                    ...
                    <div class="viewer-row">
                        <div class="viewer-avatar">
                            @if($view->viewer && $view->viewer->employerProfile && $view->viewer->employerProfile->logo)
                                <img src="{{ asset('storage/' . $view->viewer->employerProfile->logo) }}"
    ...
    <style>
        /* Analytics Dashboard Styles - Using Modern Design System */
        .analytics-dashboard {
            padding: 0;
            max-width: 1400px;
            margin: 0 auto;
        ...
        .page-header {
            ...
            border-bottom: 1px solid var(--modern-gray-200, #e2e8f0);
        }

        .page-title {
            font-size: 1.5rem;
            font-weight: 700;
            color: var(--modern-gray-900, #0f172a);
        ...
        .stat-primary .stat-icon {
            background: linear-gradient(135deg, var(--modern-primary, #6366f1) 0%, var(--modern-accent, #8b5cf6) 100%);
            color: white;
            box-shadow: 0 4px 12px rgba(99, 102, 241, 0.3);
        }

        .stat-warning .stat-icon {
            background: linear-gradient(135deg, var(--modern-warning, #f59e0b) 0%, #fbbf24 100%);
            color: white;
            box-shadow: 0 4px 12px rgba(245, 158, 11, 0.3);
        }

        .stat-success .stat-icon {
            background: linear-gradient(135deg, var(--modern-success, #10b981) 0%, #34d399 100%);
            color: white;
            box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3);
        }

        .stat-danger .stat-icon {
            background: linear-gradient(135deg, var(--modern-danger, #ef4444) 0%, #f87171 100%);
            color: white;
        ...
        .analytics-dashboard .section-header .section-title {
            font-size: 1.125rem;
            font-weight: 600;
            color: var(--modern-gray-900, #0f172a) !important;
            margin: 0;
            display: flex;
            align-items: center;
            gap: 0.625rem;
        ...
        .view-all-link:hover {
            color: var(--modern-primary-dark, #4f46e5);
            gap: 0.5rem;
        }
