                ...
                <div class="metric-content">
                    <span class="metric-label">
                        ...
                        <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Total number of times your job postings have been viewed.">
                            <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                        </span>
                    </span>
            ...
            <div class="metric-card">
                ...
                <div class="metric-content">
                    <span class="metric-label">
                        Applications
                        <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Total number of applications received.">
                            <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                        </span>
                    </span>
                    <span class="metric-value"
                        id="totalApplicationsValue">{{ number_format($totalApplications ?? 0) }}</span>
                    <span class="metric-change {{ ($applicationsChange ?? 0) >= 0 ? 'positive' : 'negative' }}"
                        id="applicationsChange">
            ...
            <div class="metric-card">
                ...
                <div class="metric-content">
                    <span class="metric-label">
                        Conversion Rate
                        <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Percentage of job views that resulted in an application.">
                            <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                        </span>
                    </span>
            ...
            <div class="metric-card">
                ...
                <div class="metric-content">
                    <span class="metric-label">
                        Avg. Time to Hire
                        <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Average number of days taken to hire a candidate.">
                            <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                        </span>
                    </span>
                    ...
                    <div class="chart-card">
                        <div class="chart-header">
                            <h5 class="chart-title">
                                ...
                                <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Visualizes the number of approved applications over the selected time period.">
                                    <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                                </span>
                            </h5>
                    ...
                    <div class="chart-card">
                        <div class="chart-header">
                            <h5 class="chart-title">
                                ...
                                <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Jobs receiving the highest number of applications.">
                                    <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                                </span>
                            </h5>
                                ...
                                @forelse($topJobs ?? [] as $job)
                                    <div class="top-job-item">
                                        <div class="job-info">
                                            ...
                                            <small class="job-date">Posted
                                                {{ $job['created_at'] ? $job['created_at']->diffForHumans() : 'recently' }}</small>
                                        </div>
                                        <div class="job-stats">
                ...
                <div class="chart-card">
                    <div class="chart-header">
                        <h5 class="chart-title">
                            ...
                            <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="The origin of your applicants (e.g., Direct, LinkedIn, Referral).">
                                <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                            </span>
                        </h5>
                ...
                <div class="chart-card">
                    <div class="chart-header">
                        <h5 class="chart-title">
                            ...
                            <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Visualizes candidate progression from application to offer extension.">
                                <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                            </span>
                        </h5>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            ...
                                            <i class="bi bi-info-circle text-muted ms-1"
                                                style="font-size: 0.8rem; cursor: pointer;" data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                                title="The total number of times this job posting has been viewed"></i>
                                        </th>
                                        <th class="text-center">
                                            Applications
                                            <i class="bi bi-info-circle text-muted ms-1"
                                                style="font-size: 0.8rem; cursor: pointer;" data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                                title="The total number of applications received for this job"></i>
                                        </th>
                                        <th class="text-center">
                                            Conversion
                                            <i class="bi bi-info-circle text-muted ms-1"
                                                style="font-size: 0.8rem; cursor: pointer;" data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                                title="The percentage of views that resulted in an application"></i>
                                        </th>
                                        <th class="text-center">
                                            Posted Date
                                            <i class="bi bi-info-circle text-muted ms-1"
                                                style="font-size: 0.8rem; cursor: pointer;" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="The date when this job was published"></i>
                                        </th>
                                        <th class="text-center">
                                            Status
                                            <i class="bi bi-info-circle text-muted ms-1"
                                                style="font-size: 0.8rem; cursor: pointer;" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="The current state of the job posting"></i>
                                        </th>
                                        <th class="text-center">
                                            Trend
                                            <i class="bi bi-info-circle text-muted ms-1"
                                                style="font-size: 0.8rem; cursor: pointer;" data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                                title="The percentage change in views compared to the previous period"></i>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($jobPerformanceBreakdown as $job)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="badge {{ $job['conversion_rate'] >= 10 ? 'bg-success' : ($job['conversion_rate'] >= 5 ? 'bg-warning text-dark' : 'bg-secondary') }}">
                                                    {{ $job['conversion_rate'] }}%
                                                </span>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="badge {{ $job['status'] == 'active' ? 'bg-success' : 'bg-secondary' }}">
                                                    {{ ucfirst($job['status']) }}
                                                </span>
                                            </td>
                                            <td class="text-center">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-muted small"><strong>Note:</strong> This only affects the display. Your actual data is
                        not deleted.</p>
                </div>
