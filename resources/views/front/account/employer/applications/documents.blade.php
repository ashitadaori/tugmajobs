        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('employer.applications.index') }}">Applications</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('employer.applications.show', $application->id) }}">{{ $application->user->name }}</a></li>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    <img src="{{ $application->user->image ? Storage::url($application->user->image) : asset('images/default-avatar.png') }}"
