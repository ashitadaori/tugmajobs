            ...
            <div class="filter-grid">
                ...
                <div class="ep-form-group" style="margin-bottom: 0;">
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search by name or email..." class="ep-form-input" style="padding-left: 40px;">
                    </div>
                </div>
    ...
    <div class="ep-stat-card compact">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                ...
                <div class="ep-stat-value" style="font-size: 1.5rem;">{{ $applications->where('status', 'pending')->count() }}</div>
            </div>
        </div>
    </div>
    <div class="ep-stat-card compact">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                ...
                <div class="ep-stat-value" style="font-size: 1.5rem;">{{ $applications->where('status', 'approved')->count() }}</div>
            </div>
        </div>
    </div>
    <div class="ep-stat-card compact">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                ...
                <div class="ep-stat-value" style="font-size: 1.5rem;">{{ $applications->where('shortlisted', true)->count() }}</div>
            </div>
        </div>
    </div>
    <div class="ep-stat-card compact">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                ...
                <div class="ep-stat-value" style="font-size: 1.5rem;">{{ $applications->where('status', 'rejected')->count() }}</div>
            </div>
        </div>
    </div>
</div>
            ...
            <table class="ep-table" style="margin-bottom: 0;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; align-items: center; gap: 12px;">
                                @if($application->user->image)
                                    <img src="{{ Storage::url($application->user->image) }}" alt="{{ $application->user->name }}" class="applicant-avatar">
                                @else
                        ...
                        <td>
                            <div style="font-weight: 500; color: var(--ep-gray-700);">{{ Str::limit($application->job->title, 35) }}</div>
                        ...
                        <td style="text-align: center; color: var(--ep-gray-600);">
                            ...
                            <div style="font-size: 11px; color: var(--ep-gray-400);">{{ $application->created_at->format('h:i A') }}</div>
                        </td>
                        <td style="text-align: center;">
                            <div style="display: flex; gap: 6px; justify-content: center;">
                                <a href="{{ route('employer.applications.show', $application->id) }}" class="ep-btn ep-btn-icon ep-btn-primary ep-btn-sm" title="View Application">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" onclick="toggleShortlist({{ $application->id }})">
                                                <i class="bi bi-star{{ $application->shortlisted ? '-fill text-warning' : '' }} me-2"></i>
                                                {{ $application->shortlisted ? 'Remove from Shortlist' : 'Add to Shortlist' }}
                                            </a>
                                        </li>
                                        @if($application->resume)
                                        <li>
                                            <a class="dropdown-item" href="{{ Storage::url('resumes/' . $application->resume) }}" target="_blank">
                                        ...
                                        <li>
                                            <a class="dropdown-item text-success" href="javascript:void(0)" onclick="updateStatus({{ $application->id }}, 'approved')">
                                        ...
                                        <li>
                                            <a class="dropdown-item text-danger" href="javascript:void(0)" onclick="updateStatus({{ $application->id }}, 'rejected')">
