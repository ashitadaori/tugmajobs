...
@section('content')
    ...
    <div class="ep-flex ep-items-center ep-justify-between ep-mb-6">
        <div>
            <p style="color: var(--ep-gray-500); font-size: var(--ep-font-size-sm); margin: 0;">Track your recruitment
                performance and insights</p>
        </div>
    ...
    <div class="ep-stats-grid ep-mb-8">
        <div class="ep-stat-card primary">
            ...
            <div class="ep-stat-label">
                ...
                <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                    title="The total number of job listings you have created since joining.">
        ...
        <div class="ep-stat-card success">
            ...
            <div class="ep-stat-label">
                Active Jobs
                <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                    title="The number of jobs currently visible to jobseekers.">
                    <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                </span>
            </div>
        ...
        <div class="ep-stat-card info">
            ...
            <div class="ep-stat-label">
                Total Applications
                <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                    title="The total count of applications received across all your jobs.">
                    <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                </span>
            </div>
        ...
        <div class="ep-stat-card warning">
            ...
            <div class="ep-stat-label">
                Profile Views
                <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                    title="How many times your company profile has been viewed by jobseekers.">
                    <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                </span>
            </div>
        ...
        <div class="ep-card">
            <div class="ep-card-header">
                <h3 class="ep-card-title">
                    ...
                    Application Trends
                    <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                        title="Visualizes the number of applications received over time.">
                        <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                    </span>
                </h3>
            </div>
        ...
        <div class="ep-card">
            <div class="ep-card-header">
                <h3 class="ep-card-title">
                    ...
                    <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                        title="Breakdown of your job postings by status (Active vs Inactive).">
                        <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                    </span>
                </h3>
            </div>
    ...
    <div class="ep-card">
        <div class="ep-card-header">
            <h3 class="ep-card-title">
                ...
                Top Performing Jobs
                <span class="ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                    title="List of your jobs with the highest engagement metrics (Applications & Views).">
                    <i class="bi bi-info-circle text-muted" style="font-size: 0.8em; cursor: pointer;"></i>
                </span>
            </h3>
                    ...
                    <tbody>
                        @forelse($topJobs as $job)
                            <tr>
                                <td>
                                    <div>
                                        <div style="font-weight: 600; color: var(--ep-gray-800); margin-bottom: 4px;">
                                            {{ $job->title }}
                                        </div>
                                ...
                                <td style="text-align: center;">
                                    <span
                                        style="font-weight: 600; color: var(--ep-primary);">{{ $job->applications_count }}</span>
                                </td>
                                <td style="text-align: center;">
