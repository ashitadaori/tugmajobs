    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="table-card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('employer.settings.notifications.update') }}">
                        @csrf
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" name="notification_preferences[email_notifications]" 
                                   ...
                                   {{ (old('notification_preferences.email_notifications', $employer->notification_preferences['email_notifications'] ?? false)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" name="notification_preferences[marketing_emails]" 
                                   ...
                                   {{ (old('notification_preferences.marketing_emails', $employer->notification_preferences['marketing_emails'] ?? false)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" name="notification_preferences[application_alerts]" 
                                   ...
                                   {{ (old('notification_preferences.application_alerts', $employer->notification_preferences['application_alerts'] ?? true)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" name="notification_preferences[job_alerts]" 
                                   ...
                                   {{ (old('notification_preferences.job_alerts', $employer->notification_preferences['job_alerts'] ?? true)) ? 'checked' : '' }}>
