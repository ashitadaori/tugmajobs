                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['job_reviews'] }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['company_reviews'] }}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="card-header py-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group" role="group">
                    <a href="{{ route('employer.reviews.index', ['type' => 'all']) }}" 
                       class="btn btn-sm {{ $filterType === 'all' ? 'btn-primary' : 'btn-outline-primary' }}">
                        All Reviews
                    </a>
                    <a href="{{ route('employer.reviews.index', ['type' => 'job']) }}" 
                       class="btn btn-sm {{ $filterType === 'job' ? 'btn-primary' : 'btn-outline-primary' }}">
                        Job Reviews
                    </a>
                    <a href="{{ route('employer.reviews.index', ['type' => 'company']) }}" 
                       class="btn btn-sm {{ $filterType === 'company' ? 'btn-primary' : 'btn-outline-primary' }}">
                        Company Reviews
                    </a>
                </div>
            </div>
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted small">
                                            <span class="badge bg-{{ $review->review_type === 'job' ? 'info' : 'warning' }} me-2">
                                ...
                                @if($review->employer_response)
                                    <div class="employer-response bg-light p-3 rounded mb-3">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            ...
                                            <small class="text-muted">{{ $review->employer_responded_at->diffForHumans() }}</small>
                                        </div>
                                        <p class="mb-0">{{ $review->employer_response }}</p>
                                        <div class="mt-2">
                                            <button class="btn btn-sm btn-outline-primary edit-response-btn" 
                                                    data-review-id="{{ $review->id }}" 
                                                    data-response="{{ $review->employer_response }}">
                            ...
                            <div class="col-md-4">
                                @if(!$review->employer_response)
                                    ...
                                    <div class="response-form">
                                        ...
                                        <form class="response-form-submit" data-review-id="{{ $review->id }}">
                                            @csrf
                                            <div class="mb-3">
