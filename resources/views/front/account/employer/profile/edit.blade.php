...
<form id="companyProfileForm" method="POST" action="{{ route('employer.profile.update') }}" enctype="multipart/form-data">
    @csrf
                ...
                <div class="ep-card-body">
                    <div class="form-grid">
                        <div class="ep-form-group">
                            ...
                            <input type="text" name="name" class="ep-form-input" value="{{ auth()->user()->name ?? '' }}" required placeholder="Enter your full name">
                        </div>
                        <div class="ep-form-group">
                            <label class="ep-form-label required">Your Email</label>
                            <input type="email" name="email" class="ep-form-input" value="{{ auth()->user()->email ?? '' }}" required placeholder="Enter your email address">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ep-card-body">
                    <div class="form-grid">
                        <div class="ep-form-group">
                            ...
                            <input type="text" name="company_name" class="ep-form-input" value="{{ $profile->company_name ?? '' }}" required placeholder="Enter your company name">
                        </div>
                        <div class="ep-form-group">
                        ...
                        <div class="ep-form-group">
                            ...
                            <input type="number" name="founded_year" class="ep-form-input" value="{{ $profile->founded_year ?? '' }}" min="1800" max="{{ date('Y') }}" placeholder="e.g. 2015">
                        </div>
                    </div>
                    <div class="ep-form-group">
                        <label class="ep-form-label required">Company Description</label>
                        <textarea name="company_description" class="ep-form-textarea" rows="4" required placeholder="Describe your company, mission, and what you do...">{{ $profile->company_description ?? '' }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="ep-card-body">
                    <div class="form-grid">
                        <div class="ep-form-group">
                            ...
                            <input type="email" name="contact_email" class="ep-form-input" value="{{ $profile->business_email ?? '' }}" required placeholder="Enter company email">
                        </div>
                        <div class="ep-form-group">
                            <label class="ep-form-label">Phone Number</label>
                            <input type="tel" name="contact_phone" class="ep-form-input" value="{{ $profile->business_phone ?? '' }}" placeholder="e.g. +63 912 345 6789">
                        </div>
                        <div class="ep-form-group">
                            <label class="ep-form-label">Website</label>
                            <input type="url" name="website" class="ep-form-input" value="{{ $profile->company_website ?? '' }}" placeholder="https://yourcompany.com">
                        </div>
                        <div class="ep-form-group">
                            <label class="ep-form-label">LinkedIn</label>
                            <input type="url" name="linkedin_url" class="ep-form-input" value="{{ $profile->linkedin_url ?? '' }}" placeholder="https://linkedin.com/company/...">
                        </div>
                        <div class="ep-form-group">
                            <label class="ep-form-label">Facebook</label>
                            <input type="url" name="facebook_url" class="ep-form-input" value="{{ $profile->facebook_url ?? '' }}" placeholder="https://facebook.com/...">
                        </div>
                        <div class="ep-form-group">
                            <label class="ep-form-label">Contact Person</label>
                            <input type="text" name="contact_person_name" class="ep-form-input" value="{{ $profile->contact_person_name ?? '' }}" placeholder="e.g. John Doe">
                        </div>
                    </div>
                    <div class="form-grid form-grid-3">
                        <div class="ep-form-group">
                            <label class="ep-form-label">City</label>
                            <input type="text" name="city" class="ep-form-input" value="{{ $profile->city ?? '' }}" placeholder="e.g. Manila">
                        </div>
                        <div class="ep-form-group">
                            <label class="ep-form-label">Province</label>
                            <input type="text" name="state" class="ep-form-input" value="{{ $profile->state ?? '' }}" placeholder="e.g. Metro Manila">
                        </div>
                        <div class="ep-form-group">
                            <label class="ep-form-label">Country</label>
                            <input type="text" name="country" class="ep-form-input" value="{{ $profile->country ?? 'Philippines' }}" placeholder="Philippines">
                        </div>
                    </div>
                    <div class="ep-form-group">
                        <label class="ep-form-label">Street Address</label>
                        <textarea name="location" class="ep-form-textarea" rows="2" placeholder="Enter your company street address...">{{ $profile->business_address ?? '' }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="ep-card ep-mb-6">
                ...
                <div class="ep-card-body">
                    <div class="ep-form-group">
                        ...
                        <textarea name="company_culture[description]" class="ep-form-textarea" rows="3" placeholder="Describe your company culture, values, and work environment...">{{ $profile->company_culture['description'] ?? '' }}</textarea>
                    </div>
                    <div class="ep-form-group">
                ...
                <div class="ep-card-body">
                    <div class="logo-upload-area">
                        @if($profile && $profile->company_logo)
                            <img src="{{ $profile->logo_url }}?v={{ time() }}" alt="Company Logo" id="logoPreview" class="logo-preview">
            ...
            <div class="ep-card ep-mb-6">
                ...
                <div class="ep-card-body">
                    ...
                    <div class="completion-checklist">
                        <div class="checklist-item {{ !empty($profile->company_name) && !empty($profile->company_description) && !empty($profile->industry) ? 'completed' : '' }}">
                            <i class="bi {{ !empty($profile->company_name) && !empty($profile->company_description) && !empty($profile->industry) ? 'bi-check-circle-fill' : 'bi-circle' }}"></i>
                            <span>Company Information</span>
                        </div>
                        <div class="checklist-item {{ !empty($profile->business_email) && !empty($profile->business_address) ? 'completed' : '' }}">
                            <i class="bi {{ !empty($profile->business_email) && !empty($profile->business_address) ? 'bi-check-circle-fill' : 'bi-circle' }}"></i>
                        ...
                        <div class="checklist-item {{ !empty($profile->company_culture) && !empty($profile->benefits_offered) ? 'completed' : '' }}">
                            <i class="bi {{ !empty($profile->company_culture) && !empty($profile->benefits_offered) ? 'bi-check-circle-fill' : 'bi-circle' }}"></i>
