...
@section('page_title', 'Create Hiring Poster')

@section('content')
<div class="create-poster-page">
    <!-- Header -->
    <div class="page-header">
        <div class="header-left">
            ...
            <div>
                <h1 class="page-title">Create Hiring Poster</h1>
                <p class="page-description">Design an eye-catching poster for your job opening</p>
            </div>
        </div>
    </div>
                    ...
                    <form id="posterForm">
                        ...
                        <div class="form-group">
                            ...
                            <select name="job_id" id="job_id" class="form-select">
                                <option value="">-- Create standalone poster --</option>
                                @foreach($jobs as $job)
                                    <option value="{{ $job->id }}"
                            ...
                            <small class="form-hint">Select a job to auto-fill poster details</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="template-grid">
                                @foreach($templates as $t)
                                    <div class="template-option {{ $t->id == $template->id ? 'selected' : '' }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control"
                                      ...
                                      required>{{ $selectedJob?->description }}</textarea>
                            <small class="form-hint">Tip: Keep it to 3-5 key requirements for best results</small>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="color" class="form-control form-control-color" id="primary_color" name="primary_color" 
                                                value="{{ old('primary_color', '#0d6efd') }}" title="Choose your color">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="color" class="form-control form-control-color" id="secondary_color" name="secondary_color" 
                                                value="{{ old('secondary_color', '#ffffff') }}" title="Choose your color">
                        ...
                        <div class="additional-details">
                            <button type="button" class="toggle-additional" data-bs-toggle="collapse" data-bs-target="#additionalFields">
                                <i class="bi bi-plus-circle me-2"></i>Additional Details (Optional)
                                <i class="bi bi-chevron-down ms-auto"></i>
                            </button>
                                ...
                                <div class="additional-fields-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               id="salary_range"
                                               name="salary_range"
                                               placeholder="e.g., PHP 30,000 - 50,000">
                                    </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn-submit" id="submitBtn">
                                <i class="bi bi-check-circle me-2"></i>Create Poster
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-7">
            <div class="preview-card">
                <div class="card-header">
                    ...
                    <span class="preview-hint">Preview updates as you type</span>
                </div>
                <div class="card-body">
                    <div id="posterPreview" class="poster-preview-container">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Job selection - auto-fill fields
    jobSelect.addEventListener('change', function() {
        const option = this.options[this.selectedIndex];
        if (option.value) {
            jobTitle.value = option.dataset.title || '';
            if (option.dataset.requirements) {
                requirements.value = option.dataset.requirements;
            }
            if (option.dataset.location) {
                location.value = option.dataset.location;
            }
            if (option.dataset.salary) {
                salaryRange.value = option.dataset.salary;
            }
            if (option.dataset.type) {
                employmentType.value = option.dataset.type;
            }
            updatePreview();
        }
    });
    ...
    function updatePreview() {
        ...
        const reqs = requirements.value || 'Requirements will appear here';
    ...
    // Trigger job select if pre-selected
    if (jobSelect.value) {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('{{ route("employer.posters.store") }}', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            if (data.status) {
                ...
                submitBtn.innerHTML = '<i class="bi bi-check-circle me-2"></i>Create Poster';
            }
        })
        .catch(error => {
