            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <div class="d-flex flex-wrap gap-3 text-muted">
                        <span><i class="fas fa-building me-1"></i> {{ $application->job->company->name ?? $application->job->employer->employerProfile->company_name ?? 'Company' }}</span>
                        <span><i class="fas fa-map-marker-alt me-1"></i> {{ $application->job->location }}</span>
                        <span><i class="fas fa-briefcase me-1"></i> {{ $application->job->jobType->name ?? 'Full-time' }}</span>
                    </div>
                    <div class="mt-2">
                        <small class="text-muted">
                            <i class="fas fa-calendar me-1"></i> Applied {{ $application->applied_date ? $application->applied_date->format('M d, Y') : $application->created_at->format('M d, Y') }}
                        </small>
                    </div>
                </div>
                    ...
                    <div class="progress-tracker">
                        ...
                        <div class="d-flex justify-content-between position-relative">
                            ...
                            @foreach($stages as $index => $stage)
                                ...
                                @endphp
                                <div class="progress-step text-center {{ $isCompleted ? 'completed' : '' }} {{ $isCurrent ? 'current' : '' }} {{ $isRejected && $index == 0 ? 'rejected' : '' }}">
                                    <div class="step-icon {{ $isCompleted ? 'bg-success text-white' : ($isCurrent ? ($application->stage_status === 'rejected' ? 'bg-danger text-white' : 'bg-primary text-white') : 'bg-light text-muted') }}">
                            ...
                            @foreach($application->statusHistory as $history)
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        @if($history->notes)
                                            <div class="message-box p-2 rounded {{ $color === 'danger' ? 'bg-danger-subtle' : ($color === 'success' ? 'bg-success-subtle' : 'bg-light') }}">
                                                <p class="mb-0">
                    ...
                    <div class="card-body py-2 px-3">
                        <div class="interview-detail-item">
                            ...
                            <div class="detail-content">
                                ...
                                <span class="detail-value">{{ $application->interview_date ? $application->interview_date->format('l, M d, Y') : 'TBD' }}</span>
                            </div>
                        </div>
                        <div class="interview-detail-item">
                            ...
                            <div class="interview-detail-item">
                                ...
                                <div class="detail-content">
                                    ...
                                    @if($application->interview_location)
                                        <a href="{{ $application->interview_location }}" target="_blank" class="btn btn-sm btn-primary mt-1">
                        ...
                        @else
                            <div class="interview-detail-item">
                                ...
                                <div class="detail-content">
                                    ...
                                    <span class="detail-value">{{ $application->interview_location ?? 'TBD' }}</span>
                                </div>
                            </div>
                        @endif
            ...
            <div class="card summary-card border-0 shadow-sm mb-3">
                ...
                <div class="card-body py-0 px-3">
                    ...
                    <div class="summary-item">
                        ...
                        <span class="summary-value">{{ $application->applied_date ? $application->applied_date->format('M d, Y') : $application->created_at->format('M d, Y') }}</span>
                    </div>
                    <div class="summary-item">
                        <div class="summary-left">
