                        ...
                        <div class="saved-job-card" data-job-id="{{ $savedJob->job->id }}">
                            <div class="company-logo">
                                @if($savedJob->job->company && $savedJob->job->company->logo)
                                    <img src="{{ asset('storage/' . $savedJob->job->company->logo) }}"
                                        alt="{{ $savedJob->job->company->name }}">
                                @elseif($savedJob->job->employer && $savedJob->job->employer->image)
                                    <img src="{{ asset('profile_img/' . $savedJob->job->employer->image) }}"
                                        alt="{{ $savedJob->job->employer->name }}">
                                @else
                                ...
                                <div class="job-meta">
                                    ...
                                    @if($savedJob->job->salary_min && $savedJob->job->salary_max)
                                        <span class="meta-item">
                                            ...
                                            {{ number_format($savedJob->job->salary_min) }} -
                                            {{ number_format($savedJob->job->salary_max) }}
                                        </span>
                                    @endif
                                </div>
