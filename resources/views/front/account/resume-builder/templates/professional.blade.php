        ...
        <div class="resume-container clearfix">
            <div class="sidebar-cell">
                ...
                <div class="sidebar-section">
                    ...
                    <p class="about-sidebar">{{ \Illuminate\Support\Str::limit($resume->data->professional_summary, 250) }}</p>
                </div>
                @endif
            ...
            <div class="main-cell">
                ...
                <div class="section">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-description">{{ \Illuminate\Support\Str::limit($project['description'], 100) }}</div>
                        @endif
                    </div>
                    @endforeach
                </div>
