...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Create Resume - {{ $template->name }}</h4>
    ...
    <form action="{{ route('account.resume-builder.store') }}" method="POST" id="resumeForm" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label>Phone</label>
                                <input type="text" name="phone" class="form-control" value="{{ $personalInfo['phone'] }}" placeholder="e.g., +1234567890">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Address</label>
                                <input type="text" name="address" class="form-control" value="{{ $personalInfo['address'] }}" placeholder="e.g., City, State">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Website (Optional)</label>
                                <input type="url" name="website" class="form-control" value="{{ $personalInfo['website'] ?? '' }}" placeholder="e.g., www.yoursite.com">
                            </div>
                            <div class="col-md-6 mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <textarea name="professional_summary" class="form-control" rows="4" placeholder="Brief overview of your professional background and career objectives...">{{ $professionalSummary ?? '' }}</textarea>
                    </div>
                </div>
