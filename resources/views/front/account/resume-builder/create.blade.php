            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="text-muted mb-0">Template: <span class="fw-bold text-primary">{{ $template->name }}</span>
                        </p>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="title"
                                    ...
                                    placeholder="Enter resume title..." required value="{{ old('title') }}">
                                    ...
                                    <div class="position-relative">
                                        <div id="photoPreview"
                                            ...
                                            @if(!empty($personalInfo['photo']) && Storage::disk('public')->exists($personalInfo['photo']))
                                                <img id="photoPreviewImg" src="{{ asset('storage/' . $personalInfo['photo']) }}"
                                                    alt="Profile Photo" style="width: 100%; height: 100%; object-fit: cover;">
                                            @else
                                                <img id="photoPreviewImg" src="{{ asset('assets/images/avatar7.png') }}"
                                                    alt="Default Photo"
                                                    style="width: 100%; height: 100%; object-fit: cover; {{ !empty($personalInfo['photo']) ? '' : 'display:none;' }}">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ old('name', $personalInfo['name']) }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="phone"
                                        ...
                                        value="{{ old('phone', $personalInfo['phone']) }}" placeholder="+1 234 567 8900">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="address"
                                        ...
                                        value="{{ old('address', $personalInfo['address']) }}" placeholder="City, Country">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="url" name="website"
                                        ...
                                        value="{{ old('website', $personalInfo['website'] ?? '') }}"
                                        placeholder="https://...">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="job_title"
                                        ...
                                        value="{{ old('job_title', $personalInfo['job_title']) }}"
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <div class="alert alert-light border-0 bg-soft-primary text-primary mb-3">
                                <i class="fas fa-info-circle me-1"></i> Auto-filled from your profile bio. Feel free to
                                customize it for this resume.
                            </div>
                                ...
                                <div class="bg-light rounded mb-3 overflow-hidden position-relative template-preview-container"
                                    ...
                                    @if(file_exists(public_path('assets/images/resume-templates/' . $imageName . '.png')))
                                        <img src="{{ asset('assets/images/resume-templates/' . $imageName . '.png') }}"
                                            alt="{{ $template->name }}" class="img-fluid w-100 h-100"
