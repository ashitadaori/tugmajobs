...
<div class="job-detail-hero">
    <div class="container-fluid px-0">
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav ws-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item ws-breadcrumb-item"><a href="{{ route('home') }}"><i class="fas fa-home"></i> Home</a></li>
                <li class="breadcrumb-item ws-breadcrumb-item"><a href="{{ route('jobs') }}"><i class="fas fa-briefcase"></i> Jobs</a></li>
                <li class="breadcrumb-item ws-breadcrumb-item active" aria-current="page">{{ Str::limit($job->title, 30) }}</li>
            </ol>
        </nav>
                    ...
                    <div class="d-flex align-items-start gap-3 ws-flex ws-items-start ws-gap-3">
                        ...
                        <div class="flex-grow-1">
                            <div class="job-meta-tags mb-2 ws-flex ws-flex-wrap ws-gap-2">
                                <span class="job-type-badge ws-badge ws-badge-primary {{ strtolower($job->jobType->name) }}">
                                ...
                                <span class="posted-badge ws-badge ws-badge-secondary">
                                    <i class="fas fa-clock"></i> Posted {{ \Carbon\Carbon::parse($job->created_at)->diffForHumans() }}
                                </span>
                            </div>
                        ...
                        @auth
                            @if(Auth::user()->role === 'jobseeker')
                                <button type="button"
                                        ...
                                        class="btn-modern btn-save ws-btn ws-btn-outline {{ $count > 0 ? 'saved ws-btn-success' : '' }}"
                                        aria-label="{{ $count > 0 ? 'Remove from saved' : 'Save for later' }}">
                                    <i class="fa-heart {{ $count > 0 ? 'fas' : 'far' }}" id="saveJobIcon-{{ $job->id }}"></i>
                                    <span>{{ $count > 0 ? 'Saved' : 'Save' }}</span>
                                </button>
                    ...
                    <div class="overview-grid ws-grid" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem;">
                        <div class="overview-item ws-flex ws-items-center ws-gap-3">
                            ...
                            <div class="overview-content">
                                ...
                                <span class="overview-value ws-text-lg ws-font-semibold">{{ $job->salary ?? 'Negotiable' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="overview-item ws-flex ws-items-center ws-gap-3">
                            ...
                            <div class="overview-content">
                                ...
                                <span class="overview-value ws-text-lg ws-font-semibold">{{ $job->jobType->name }}</span>
                            </div>
                        </div>
                        ...
                        <div class="overview-item ws-flex ws-items-center ws-gap-3">
                            ...
                            <div class="overview-content">
                                ...
                                <span class="overview-value ws-text-lg ws-font-semibold">{{ $job->vacancy }} Position(s)</span>
                            </div>
                        </div>
                        ...
                        <div class="overview-item ws-flex ws-items-center ws-gap-3">
                            ...
                            <div class="overview-content">
                                ...
                                <span class="overview-value ws-text-lg ws-font-semibold">{{ \Carbon\Carbon::parse($job->created_at)->format('M d, Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="quick-apply-content">
                        ...
                        <div class="apply-info-item">
                            ...
                            <div>
                                ...
                                <span class="info-value">{{ \Carbon\Carbon::parse($job->created_at)->format('M d, Y') }}</span>
                            </div>
                        </div>
                        <div class="apply-info-item">
                        ...
                        @if (!empty($job->employer->employerProfileDirect->founded_year))
                            <div class="company-detail-item">
                                ...
                                <div class="detail-content">
                                    ...
                                    <span class="detail-value">{{ $job->employer->employerProfileDirect->founded_year }}</span>
                                </div>
                            </div>
                        @endif
                        ...
                        @if (!empty($job->employer->employerProfileDirect->website))
                            <div class="company-detail-item">
                                ...
                                <div class="detail-content">
                                    ...
                                    <a href="{{ $job->employer->employerProfileDirect->website }}" target="_blank" class="website-link-modern">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="btn-group w-100" role="group">
                            <input type="radio" class="btn-check" name="review_type" id="reviewTypeJob" value="job" 
                                   {{ !$canReviewJob ? 'disabled' : 'checked' }}>
                            <label class="btn btn-outline-primary {{ !$canReviewJob ? 'disabled' : '' }}" for="reviewTypeJob">
                            ...
                            <input type="radio" class="btn-check" name="review_type" id="reviewTypeCompany" value="company"
                                   {{ !$canReviewCompany ? 'disabled' : ($canReviewJob ? '' : 'checked') }}>
                            <label class="btn btn-outline-primary {{ !$canReviewCompany ? 'disabled' : '' }}" for="reviewTypeCompany">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 20px; border: none; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.15);">
            ...
            <div class="modal-footer border-0" style="padding: 0 2rem 2rem 2rem;">
                ...
                <a href="{{ route('kyc.index') }}" class="btn text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 10px; padding: 0.75rem 1.5rem; font-weight: 600;">
