            ...
            <div class="jobs-header-left">
                ...
                <div class="header-text">
                    ...
                    <p class="jobs-subtitle">
                        ...
                        Discover <strong>{{ $jobs->total() }}</strong> opportunities matching your career goals
                    </p>
                </div>
            </div>
        ...
        <aside class="jobs-sidebar">
            <div class="filter-panel">
                <div class="filter-panel-header">
                    ...
                    <a href="{{ route('jobs') }}" class="filter-clear-btn">
                ...
                <form action="" method="GET" id="searchForm" class="filter-form">
                    ...
                    <div class="filter-section">
                        ...
                        <input type="hidden" name="location_filter_latitude" id="location_filter_latitude" value="{{ Request::get('location_filter_latitude') }}">
                        <input type="hidden" name="location_filter_longitude" id="location_filter_longitude" value="{{ Request::get('location_filter_longitude') }}">
                        ...
                        <div class="filter-select-wrapper">
                            <select name="jobType" id="jobType" class="filter-select">
                                ...
                                @foreach($jobTypes as $jobType)
                                    <option value="{{ $jobType->name }}" {{ Request::get('jobType') == $jobType->name ? 'selected' : '' }}>
                                        {{ $jobType->name }}
                                    </option>
                                @endforeach
                            </select>
        ...
        <main class="jobs-main">
            ...
            <button type="button" class="mobile-filters-btn" id="mobileFilterToggle">
                ...
                @if(Request::get('keyword') || Request::get('location') || Request::get('jobType'))
                    <span class="filter-count">{{ (Request::get('keyword') ? 1 : 0) + (Request::get('location') ? 1 : 0) + (Request::get('jobType') ? 1 : 0) }}</span>
                @endif
            </button>
            ...
            @if($userHasPreferences)
                <div class="smart-match-banner active">
                    ...
                    <div class="smart-match-content">
                        ...
                        <span>Personalized results based on {{ count($userCategories) }} {{ Str::plural('preference', count($userCategories)) }}</span>
                    </div>
