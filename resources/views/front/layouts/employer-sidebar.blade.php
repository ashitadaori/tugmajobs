    ...
    <div class="user-profile">
        <div class="profile-container">
            ...
            @elseif($employerProfile && $employerProfile->company_logo)
                <img src="{{ $employerProfile->logo_url }}" alt="Company Logo" class="profile-photo"
                    onerror="this.onerror=null; this.src='{{ asset('images/default-company-logo.svg') }}';">
            @else
                <img src="{{ asset('images/default-company-logo.svg') }}" alt="Company Logo"
                    class="profile-photo default-logo">
            @endif
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <ul class="nav-list">
                ...
                <li class="nav-item">
                    <a href="{{ route('employer.posters.index') }}"
                        class="nav-link {{ request()->routeIs('employer.posters.*') ? 'active' : '' }}">
                        <i class="bi bi-images nav-icon"></i>
                        <span class="nav-text">Poster Builder</span>
                        <span class="badge bg-info text-white ms-auto" style="font-size: 0.65rem;">NEW</span>
                    </a>
                </li>
            </ul>
        </div>
