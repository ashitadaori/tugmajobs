                    ...
                    <a href="{{ route('companies') }}" 
                       class="nav-link {{ request()->routeIs('companies*') ? 'active' : '' }}">
                        ...
                        @if($newCompaniesCount > 0)
                            <span class="badge bg-success ms-2" style="font-size: 0.7rem; padding: 0.2rem 0.5rem;">{{ $newCompaniesCount }} New</span>
                        @endif
                    </a>
                </li>
                <li class="nav-item">
                       ...
                       class="nav-link {{ request()->routeIs('account.saved-jobs.index') ? 'active' : '' }}">
                        ...
                        @auth
                            @if(auth()->user()->role === 'jobseeker')
                                <span class="badge bg-light text-dark ms-2 saved-jobs-count">{{ auth()->user()->savedJobs()->count() }}</span>
                            @endif
                        @endauth
                    </a>
                </li>
