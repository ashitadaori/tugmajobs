...
<body class="@if(request()->routeIs('home') || request()->has('force_home')) homepage @endif @if(request()->routeIs('jobs') || request()->routeIs('jobs.*')) jobs-page @endif @if(request()->routeIs('companies') || request()->routeIs('companies.*')) companies-page @endif @if(request()->has('force_home')) force-home @endif">
    @auth
    ...
    <div class="main-content">
        @if(request()->routeIs('home') || request()->has('force_home'))
