<div class="dropdown employer-notif-wrapper">
    <button type="button" class="employer-notif-bell-btn {{ Auth::user()->unreadNotificationsCount > 0 ? 'has-unread' : '' }}" id="notificationDropdown" data-bs-toggle="dropdown" aria-expanded="false">
