                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-7 p-5 position-relative bg-white">
                        ...
                        <div id="employerLoginForm" class="auth-form">
                            ...
                            <!-- Google Login Button -->
                            <div class="mb-4">
                                <a href="{{ route('social.redirect', ['provider' => 'google', 'role' => 'employer']) }}" class="btn btn-outline-secondary w-100 social-btn google-btn d-flex align-items-center justify-content-center">
                            ...
                            <form method="POST" action="{{ route('employer.login.submit') }}" class="needs-validation" novalidate id="employerLoginFormElement">
                                @csrf
                        ...
                        <div id="employerRegisterForm" class="auth-form" style="display: none;">
                            ...
                            <form method="POST" action="{{ route('employer.register.submit') }}" class="needs-validation" novalidate id="employerRegisterFormElement">
                                @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    @if($errors->has('name') || $errors->has('password_confirmation') || $errors->has('confirm_password'))
        switchToEmployerRegister();
        // If registration was using password method, show password fields
        @if(old('registration_method') === 'password')
