...
<div class="jobseeker-sidebar">
    <div class="user-profile mb-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <span class="badge bg-primary mt-1">Job Seeker</span>
            </div>
        </div>
    </div>
    ...
    <div class="sidebar-section mb-4">
        ...
        <div class="nav-item">
            <a href="{{ route('account.saved-jobs.index') }}" 
               class="nav-link {{ request()->routeIs('account.saved-jobs.index') ? 'active' : '' }}">
    ...
    <!-- Profile Section -->
    <div class="sidebar-section mb-4">
        <p class="sidebar-label mb-3">Profile</p>
    ...
    <div class="sidebar-section">
        ...
        <div class="nav-item">
            <a href="{{ route('account.jobAlerts') }}" 
               class="nav-link {{ request()->routeIs('account.jobAlerts') ? 'active' : '' }}">
